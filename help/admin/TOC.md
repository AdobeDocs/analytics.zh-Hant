...
product: analytics
audience: admin
user-guide-title: Analytics管理指南
...
+ [Analytics管理員說明](home.md)
+ Analytics Admin overview {#admin-overview}
   + [我應該使用哪一種Adobe Analytics工具？](c-analytics-product-comparison/which-analytics-tool.md)
...
+ 管理工具 {#admin-tools}
   ...
   + 付費搜尋偵測 {#paid-search-detection}
      + [付費搜尋偵測概述](admin/paid-search-detection/paid-search-detection.md)
   ...
   + 處理規則 {#processing-rules}
      + [處理規則概述](admin/c-processing-rules/processing-rules.md)
      + Processing rules configuration {#processing-rules-configuration}
         ...
         + [複製處理規則至其他報告套裝](admin/c-processing-rules/c-processing-rules-configuration/t-processing-rules-copy-to-rs.md)
      + [用於處理規則的維度](admin/c-processing-rules/processing-rule-dimensions.md)
      + Processing rules examples {#processing-rules-examples}
         ...
         + [從查詢字串參數填入促銷活動ID](admin/c-processing-rules/processing-rules-examples/processing-rules-populate-campaign-id.md)
         + [從產品概述頁面設定產品檢視事件](admin/c-processing-rules/processing-rules-examples/setting-the-product-view-event.md)
         + [串連類別和頁面名稱以新增子類別](admin/c-processing-rules/processing-rules-examples/subcategory-concatenating.md)
         + [將eVar值複製至prop以判斷路徑](admin/c-processing-rules/processing-rules-examples/processing-rules-determining-path.md)
         ...
         + [複製上下文資料變數至eVar](admin/c-processing-rules/processing-rules-examples/processing-rules-copy-context-data.md)
         + [使用上下文資料變數設定事件](admin/c-processing-rules/processing-rules-examples/processing-rules-copy-context-data-event.md)
         + [從點擊移除事件](admin/c-processing-rules/processing-rules-examples/processing-rules-remove-event.md)
      + [處理規則提示與秘訣](admin/c-processing-rules/processing-rules-tips.md)
   + 即時報表 {#real-time-reports}
      + [即時報告概述](admin/realtime/realtime.md)
      + [即時報告設定](admin/realtime/t-realtime-admin.md)
      + [支援的即時度量和維度](admin/realtime/realtime-metrics.md)
   ...
   + Server-side forwarding {#server-side-forwarding}
      ...
      + [伺服器端轉送資料與程式碼參考](admin/c-server-side-forwarding/ssf-reference.md)
      + [如何驗證您的伺服器端轉送實作](admin/c-server-side-forwarding/ssf-verify.md)
      + [伺服器端轉送常見問題](admin/c-server-side-forwarding/ssf-faq.md)
   + [簡化的報告功能表](admin/t-simplified-menu.md)
...
+ Experience Cloud Admin Console {#admin-console}
   ...
   + 權限 {#permissions}
      ...
      + [Analytics工具權限項目](admin-console/permissions/analytics-tools.md)
   + [Adobe Analytics第一個管理指南](admin-console/first-admin-guide.md)
   + [建立報表套裝](admin-console/create-report-suite.md)
+ 公司設定 {#company-settings}
   + [公司設定概觀](company/c-company-settings.md)
   + [功能存取等級](company/feature-access-levels.md)
   + [網站服務](company/web-services-admin.md)
   + [報告建立工具報表](company/report-builder-reports-admin.md)
...
+ Manage report suites {#manage-report-suites}
   + [報告套裝管理員](c-manage-report-suites/report-suites-admin.md)
   + [統計和全域報告套裝](c-manage-report-suites/rollup-report-suite.md)
   + [建立統計報表套裝](c-manage-report-suites/t-rollups.md)
   + Report suite templates {#report-suite-templates}
      + [報表套裝範本概述](c-manage-report-suites/c-report-suite-templates/report-suite-templates.md)
      + [匯整入口網站](c-manage-report-suites/c-report-suite-templates/aggregator-portal.md)
   ...
   + [個別報表套裝設定](c-manage-report-suites/individual-rs-settings.md)
   ...
   + New report suite {#new-report-suite}
      ...
      + [不是從來源報表套裝複製的設定](c-manage-report-suites/c-new-report-suite/settings-not-copied-from-rs.md)
...
+ User and Product Management (Legacy) {#user-product-management}
   ...
   + Customize report access {#customize-report-access}
      + [自訂報告存取-概述](user-management2/c-customize-report-access/groups-customize-report-access.md)
      + [自訂Analytics工具權限](user-management2/c-customize-report-access/groups-analytics-tools.md)
...
+ 資料控管 {#data-governance}
   ...
   + [檢視/管理報表套裝的資料治理設定](c-data-governance/gdpr-view-settings.md)
   + [標籤報表套裝資料](c-data-governance/gdpr-setup-reportsuite.md)
   + [提交存取和刪除要求](c-data-governance/gdpr-submit-access-delete.md)
   + [Analytics變數的GDPR標籤](c-data-governance/gdpr-labels.md)
   + [命名空間](c-data-governance/gdpr-namespaces.md)
   + [ID擴增](c-data-governance/gdpr-id-expansion.md)
   + [標籤最佳實務](c-data-governance/gdpr-analytics-ids.md)
   + [標籤範例](c-data-governance/gdpr-labeling-example.md)
   + [GDPR 與 Data Connectors (Genesis)](c-data-governance/data-connectors-gdpr.md)
   + [GDPR術語](c-data-governance/gdpr-terminology.md)
+ 伺服器呼叫使用量 {#server-call-usage}
   + [伺服器呼叫使用概觀](c-server-call-usage/overage-overview.md)
   + [檢視目前伺服器呼叫使用情況](c-server-call-usage/server-call-usage-dashboard.md)
   + [檢視報表套裝使用情形](c-server-call-usage/report-suite-usage.md)
   + [伺服器呼叫使用警示](c-server-call-usage/scu-alerts.md)
   + [伺服器呼叫使用常見問題](c-server-call-usage/overage-faq.md)
+ 流量管理 {#traffic-management}
   + [DVR-刪除](admin/c-traffic-variables/traffic-classifications.md)
   + [管理流量](c-traffic-management/traffic-management.md)
   + [排程流量尖峰](c-traffic-management/t-traffic-schedule-spike.md)
   + [預估過去伺服器呼叫次數並排程流量尖峰](c-traffic-management/traffic-spike-estimate-past-server-calls.md)
   + [指定永久性流量增加](c-traffic-management/t-traffic-permanent.md)
   + [流量增加的必要前置時間](c-traffic-management/traffic-lead-time.md)
