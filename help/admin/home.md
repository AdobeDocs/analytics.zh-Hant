...
* Adobe Admin Console: 使用此區域來佈建 Experience Cloud 工具，並管理使用者權限。It is located at [adminconsole.adobe.com](https://adminconsole.adobe.com).
...
本指南不涵蓋 Adobe Admin Console 提供的許多一般功能。請參閱「企 [業版」使用指南中](https://helpx.adobe.com/enterprise/using/admin-console.html) 的「管理控制台」。
