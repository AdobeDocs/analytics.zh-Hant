...
如果資料主體提交請求並提交識別碼(自訂變數 — prop或eVar)，則Adobe Analytics會掃描針對指定識別碼收集之資料的整個保留歷史記錄。 如需進一步了解如何設定 Analytics prop 或 eVar 中儲存的自訂 ID，請參閱[命名空間上的 Analytics 文件](/help/admin/c-data-governance/data-labeling/gdpr-namespaces.md)。
