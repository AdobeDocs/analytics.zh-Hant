...
**資料保護機關** - 在歐盟內負責保護資料和隱私權及監控與實施作業資料保護規範的國家機關
...
**身分管理服務 (IMS)** - Adobe 實施作業 Federated ID 和 OAuth 2.0 以驗證 Adobe ID 使用者及授權 Adobe 資源。您必須整合 IMS 和您的 Adobe 應用程式或服務以讓使用者登入及存取 Adobe 服務。使用者可透過 Renga (Adobe 的身分服務提供者) 直接登入，或透過信任的協力廠商驗證網域 (例如 Google、Facebook 或公司/組織 LDAP)。
