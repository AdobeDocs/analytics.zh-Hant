...
|---|---|---|---|---|---|
| 變數名稱<br>(命名空間) | MyProp(<br>使用者) | 訪客ID<br>(AID) | MyEvar1 | MyEvar2 | MyEvar(<br>xyz) |
| 點擊資料 | Mary | 77 | A | M | X |
|  | Mary | 88 | B | N | Y |
|  | Mary | 99 | C | O | Z |
|  | John | 77 | D | P | W |
...
| API 值 | API 值 | 傳回的檔案類型 | <br>摘要存取檔案中的資料 </br> | <br>摘要存取檔案中的資料</br> | <br>摘要存取檔案中的資料</br> | <br>摘要存取檔案中的資料</br> | <br>摘要存取檔案中的資料</br> |
|--- |--- |--- |---|---|---|---|---|
