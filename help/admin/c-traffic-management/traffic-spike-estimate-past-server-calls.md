...
seo-description: 您可取得 (舉例來說) 去年特定時間範圍內伺服器的每日平均呼叫數，再加上今年伺服器呼叫的預估可能增加次數。如此一來，您便可以根據此乘數因子，為流量尖峰制定排程。
...
1. 按一下「**[!UICONTROL 展開]**」以展開報表套裝清單，然後按一下「**選取報表套裝]」以選取多個報表套裝。[!UICONTROL **
