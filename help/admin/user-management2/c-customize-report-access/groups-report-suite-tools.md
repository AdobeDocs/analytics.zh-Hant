...
| [付費搜尋](https://marketing.adobe.com/resources/help/en_US/reference/paid_search_detection.html) | 「付費搜尋偵測」可區分「搜尋引擎」與「搜尋關鍵字」報表中的付費與免費搜尋。 |
...
| [不重複訪客](https://marketing.adobe.com/resources/help/en_US/reference/t_unique_visitor_variable.html) | 授予指定獨特訪客變數的權限。 |
...
| [頻道報表](https://marketing.adobe.com/resources/help/en_US/mchannel/index.html) | 授予對可以在「報表 &gt; 行銷管道報表」中找到的行銷管道報表的權限。 |
...
| **控制面板項目** |  |
| 控制面板項目中的設定可讓您存取「Reports &amp; Analytics 」中的[報表](https://marketing.adobe.com/resources/help/en_US/sc/user/dashboard.html): 我的建議報表、公司摘要報表、影像、KPI/量規報表、報表套裝總計、文字、小報表、使用摘要報表和網頁資源 |  |
| **其他** |  |
