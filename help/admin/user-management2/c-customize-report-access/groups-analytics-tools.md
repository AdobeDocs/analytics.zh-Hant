...
seo-title: 自訂Analytics工具權限
solution: Analytics
subtopic: 使用者和群組
title: 自訂Analytics工具權限
topic: 管理工具
...
**[!UICONTROL 使用者管理]** &gt; **[!UICONTROL 群組]** &gt; **[!UICONTROL 報表存取]** &gt; **[!UICONTROL Analytics工具]** &gt; **[!UICONTROL 自訂]**
...
|--- |--- |
| **一般** |  |
| [帳單](../../../admin/admin/billing-admin.md) | 可讓您存取帳單資訊，包括每個報表套裝的流量細節。 |
...
| [ClickMap](https://marketing.adobe.com/resources/help/en_US/sc/user/clickmap.html) | 在標題的[!UICONTROL 工具]功能表中顯示 ClickMap。<br>(**注意：** Adobe建議使用 [Activity Map](https://marketing.adobe.com/resources/help/en_US/analytics/activitymap/activitymap-enable.html)。) |
...
| [在 Analysis Workspace 中建立/組織專案](https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/curate.html) | 授予在 Analysis Workspace 中建立和組織專案的使用者權限。 |
