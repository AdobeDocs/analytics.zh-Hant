...
[建立報告套裝](/help/admin/tools/manage-rs/new-rs/t-create-a-report-suite.md)時所使用的元素說明。
...
| 使用簡化版導覽功能表 | 此功能是[Reports &amp; Analytics](https://new.express.adobe.com/webpage/WFCyq7w8kijmB？)的一部分，已不再支援。 |
