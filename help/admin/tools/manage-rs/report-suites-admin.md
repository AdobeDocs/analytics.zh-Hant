...
Analytics解決方案會針對這些資料存放區進行彙總及報告。 管理的「報表套裝管理員」可讓您定義用以控管如何在報表套裝中處理資料的規則。
...
<table id="table_F739FBD8DB8D409E916F12F61C5953D0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 可讓您在報表套裝清單中找出特定的報表套裝。 搜尋工具包含以名稱為基礎的基本搜尋和進階搜尋頁面，以供深入搜尋使用。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="wintitle">群組 </span> </td> 
   <td colname="col2"> <p>可讓您將報表套裝組織到自訂群組中。 您可以快速存取共用類似設定或您經常一起編輯的多個報表套裝。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>「統計」是指將數個其他報表套裝的追蹤資料結合在內的單一報表套裝。 </p> <p>請參閱<a href="/help/admin/tools/manage-rs/rollup-report-suite.md">統計報表套裝</a>。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2">請參閱<a href="/help/admin/tools/manage-rs/new-rs/new-report-suite.md">新的報表套裝</a>。 </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>在「管理工具」，以及行銷報表標頭的報表套裝下拉式清單中，識別報表套裝。 </p> <p>請參閱<a href="/help/admin/tools/manage-rs/new-rs/new-report-suite.md">新的報表套裝</a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="wintitle"> 基礎 URL</span> </td> 
   <td colname="col2"> <p>定義報表套裝的基本網域。 </p> <p>請參閱<a href="/help/admin/tools/manage-rs/new-rs/new-report-suite.md">新的報表套裝</a>。 </p> </td> 
  </tr> 
 </tbody> 
</table>
