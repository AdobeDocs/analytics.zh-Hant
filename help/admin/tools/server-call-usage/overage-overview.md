...
<table id="table_4E97F85F13344A2C962FA4FA5A51642E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>為伺服器呼叫計費的法人。 例如 adobe.com。 每個帳單公司都有一個用於唯一識別帳單客戶的帳單ID。 帳單ID可以繫結至多個Experience Cloud組織；組織與帳單ID之間並不一定存在1:1關係。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_86256AD8B4554F369439A8FDF2F545E1"> 
 <thead> 
  <tr> 
   ...
   <th colname="col4" class="entry"> 如果您已登入Adobe Experience Cloud，請授與許可權 </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
