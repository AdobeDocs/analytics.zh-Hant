...
Analytics 管理工具區域是管理 Adobe Analytics 執行個體的主要區域；大部分管理任務都可以在這裡完成。 Analytics管理的另一個區域「Adobe Admin Console」是布建使用者和設定許可權。
...
>[!WARNING]
>
>請勿在同個瀏覽器中開啟數個「管理員」標籤。 這可能會導致您不小心將設定儲存到錯誤的報表套裝。 例如，如果您需要比較規則集並將它們複製到新的報表套裝，我們建議您開啟新的瀏覽器或拍攝熒幕快照以比較規則集。
