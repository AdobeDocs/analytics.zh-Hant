...
| HTTP 標題 | 說明 | h_鍵被Audience Manager接受 |
| --- | --- | --- |
...
| c_clientDateTime | 時間戳，格式為dd/mm/yyy hh:mm:ss W TZ 。    TZ 的單位為分鐘，且符合 Date.getTimezoneOffset 方法的回傳。 |
