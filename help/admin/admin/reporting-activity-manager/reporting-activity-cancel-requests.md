...
* 您可以取消特定的請求、取消來自特定使用者的所有請求或取消與特定專案相關的所有請求。
  ...
  當您取消請求時，此動作將記錄在[記錄檔](/help/admin/admin/logs.md)中。此「[!UICONTROL **事件類型**]」欄顯示為「[!UICONTROL **管理員動作**]」，且可使用「[!UICONTROL **事件**]」欄的取消說明。

* 當您取消請求時，您也可以選擇指定時段的限制後續請求。

  當您限制後續請求時，此動作將記錄在[記錄檔](/help/admin/admin/logs.md)中。此「[!UICONTROL **事件類型**]」欄顯示為「[!UICONTROL **管理員動作**]」，且可使用「[!UICONTROL **事件**]」欄的限制說明。
...
1. 請選取要取消報告請求的報告套裝。<!--double-check this step-->
   ...
   有關此頁面上可用資料的更多資訊，請參閱[在報告活動管理員中檢視報告活動](/help/admin/admin/reporting-activity-manager/reporting-activity.md)。
...
1. (可選) 若要限制指定時段的未來請求：
   ...
   1. 從下列選項中選擇：
      ...
      | 選項 | 函數 |
      |---------|----------|
      | [!UICONTROL **使用者與專案**] | 將暫時限制與選取請求相關的使用者，無法執行相關專案的報告請求。 |
      | [!UICONTROL **使用者**] | 將暫時限制與選取請求相關使用者所提出的任何報告請求。 |
      | [!UICONTROL **專案**] | 將暫時限制與選取請求相關專案執行所有報告請求。 |
...
1. (可選) 若要限制指定時段的未來請求：
   ...
   1. 從下列選項中選擇：
      ...
      | [!UICONTROL **使用者**] | 將暫時限制選取的使用者，無法提出任何報告請求。 |
      | [!UICONTROL **專案**] | 將限制與選取使用者相關的專案，無法由任何使用者提出任何報告請求。 |
      | [!UICONTROL **限制**] | 選擇限制請求的時間長度。您可以選擇 1 分鐘 (預設)、5 分鐘、10 分鐘、15 分鐘或 30 分鐘。<!--double-check this--> <p>設定限制後，您無法提前移除限制。</p> |
...
1. (可選) 若要限制指定時段的未來請求：
   ...
   1. 從下列選項中選擇：
      ...
      | [!UICONTROL **使用者**] | 將限制與選取專案相關的使用者，無法提出任何報告請求。 |
