...
2. 導覽至 **[!UICONTROL Analytics]** > **[!UICONTROL 管理員]** > **[!UICONTROL 所有管理員]** > **[!UICONTROL 資料設定和收集]** > **[!UICONTROL 資料控管]**。
   ...
   >[!NOTE]
   >
   >如果並未看到此選單項目，則需要將您新增至 [Admin Console 的產品設定檔](https://experienceleague.adobe.com/docs/analytics/admin/admin-console/permissions/product-profile.html)，並提供您使用此功能的權限，或是已提供在 Admin Console 中報告套裝的存取權。
...
| **[!UICONTROL 身分識別]** | 身分識別資料「I」標籤可用來分類可身分識別身分識別或聯絡特定人員的資料。[了解更多](https://experienceleague.adobe.com/docs/analytics/admin/data-governance/data-labels/gdpr-labels.html#data-privacy-identity-labels) |
