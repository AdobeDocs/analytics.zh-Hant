...
1. 啟用或停用[參與率度量](/help/components/c-variables/c-metrics/metrics-participation.md)。
   ...
   >[!NOTE]
   >
   >您可以啟用的參與率最多可達 100 個自訂事件。除此之外，您還可在[計算量度](https://docs.adobe.com/content/help/zh-Hant/analytics/components/calculated-metrics/calcmetric-workflow/participation-metric.html)產生器中建立參與率量度。
