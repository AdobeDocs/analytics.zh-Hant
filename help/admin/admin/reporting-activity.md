...
| [!UICONTROL 應用程式] | 支援的應用程式 [!UICONTROL 報表活動管理員] 為： <ul><li>Analysis Workspace UI</li><li>工作區已排程專案</li><li>Report Builder</li><li>建立器UI:區段、計算量度、註解、對象等</li><li>來自1.4或2.0 API的API呼叫</li><li>智慧型警報</li></ul> |
