...
>[!IMPORTANT]
>
>使用者和產品管理功能已移至 [Adobe Admin Console](https://helpx.adobe.com/tw/enterprise/using/admin-console.html)。 若要開始管理Adobe Analytics使用者的使用者權限，請參閱 [Adobe Admin Console中的Analytics][/help/admin/admin-console/home.md].
