...
# Analytics使用者移轉至Adobe Admin Console{#analytics-user-migration-to-the-admin-console}

關於將Analytics使用者ID移轉至Adobe Experience Cloud中Adobe Admin Console的需知事項。

如需Adobe Admin Console主題的一般說明（與Analytics移轉無關），請參閱 [Admin Console使用手冊](https://helpx.adobe.com/tw/enterprise/administering/user-guide.html).

移轉後，您可以 [管理Experience Cloud使用者和產品](https://experienceleague.adobe.com/docs/core-services/interface/manage-users-and-products/admin-getting-started.html?lang=zh-Hant) 在Adobe Admin Console。
...
<table id="table_36FD7EF1DAB44D359F4FC186D93147E5"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe 會透過電子郵件通知 Analytics 管理員，告知開始移轉的時間並附上相關指示。 </p> <p>移轉至Adobe Admin Console的過程將按批次進行。 移轉當天，Adobe 會通知 Analytics 管理員，並授予移轉工具存取權。登入公司達到為每個移轉階段定義的條件後，Adobe 會： </p> 
    ...
    </ul> <p> 移轉當天，您先前的權限群組會自動複製到Adobe Admin Console。 您將無法在 Analytics「管理工具」中邀請新的使用者或建立新群組。 </p> <p>移轉之後： </p> 
    <ul id="ul_4639963EB08F407F8C18ACE2B3D30223"> 
     <li id="li_7F24A3FC900146C3B2E988D399C859EA">管理員將使用Adobe Admin Console來管理其Analytics使用者和權限。 (您將無法再使用「Analytics &gt; 管理 &gt; 使用者管理」中的使用者管理介面)。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>移轉開始日期上午 10 點 (UTC)： </p> 
    <ul id="ul_25D1DBDF5C804D048E741F31550FF5F3"> 
     <li id="li_418476105FE341229CE146E730AAB33D">您在Analytics中的現有權限群組會自動在Adobe Admin Console中複製為產品設定檔，包括其說明以及報表套裝、量度、維度、Analytics和報表套裝工具的精細權限。 </li> 
     <li id="li_412F88C454B0455A8F3BC8016226855C">如果您目前的任何Analytics使用者是在Adobe Admin Console中建立(這表示他們有連結的Adobe/Enterprise ID)，則會將他們新增至Adobe Admin Console中適當的產品設定檔。 </li> 
     <li id="li_8A05137EC05C4FD5910E73FE58300DCB">Analytics中「管理員」標籤下方的「使用者管理」區段將設為 <span class="term"> 只讀</span>. 您將無法在此處建立新的使用者或權限群組，且需要在Adobe Admin Console中執行這兩項功能。 請參閱 <a href="/help/admin/admin-console/user-management2/user-migration/c-migration-tool.md#section-928ffba27a0446e0af575b720434ef56"> Adobe Admin Console中不支援的Analytics功能</a> 以取得更多資訊。 </li> 
     ...
     <li id="li_095D42E3A3544FC59A60A8C8F94C971B">您將有權存取Adobe Admin Console中的「權限」索引標籤，該索引標籤可讓您使用您在Analytics中熟悉的所有精細選項來建立產品設定檔。 </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>我要如何移轉使用者 ID？ </p> </td> 
   <td colname="col2"> <p> 按一下管理頁面上「使用者管理」下方的<a href="/help/admin/admin-console/user-management2/user-migration/t-migrate-users.md#task-f3355f3b14a340feae58cfa04c0ba1c9">移轉使用者 ID</a>。 使用此工具將使用者新增至Adobe Admin Console中的產品設定檔（從Analytics的權限群組複製）。 您可依照自己的步調來移轉使用者 ID。 </p> <p>需要管理員權限。移轉完成後便無法回復。 </p> <p>移轉結束日期當天，使用者在登入公司內對 <span class="filepath">my.omniture.com</span> 的存取權限將會停用。使用者 (包括尚未移轉的使用者) 會經由系統重新導向，透過新的 Experience Cloud URL (<span class="filepath">experiencecloud.adobe.com</span>) 登入。 </p> <p>註解：Adobe 建議您藉此機會在移轉前對使用者與群組執行審核。刪除未使用的舊帳戶，或不應該再存取產品的帳戶 (例如組織的離職員工)。 </p> <p>相關主題：<a href="/help/admin/admin-console/user-management2/user-migration/migrate-enterprise.md">移轉 Enterprise ID 與 Federated ID 的 Analytics 使用者帳戶</a> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>是。然而，Adobe 建議您利用移轉開始前的時間： </p> 
    <ul id="ul_52C7EC44A5534975BFD7A6F37A829C25"> 
     <li id="li_8CFFF72877E8456DAC3241143AD648AD">確認您是Adobe Admin Console中的Analytics產品管理員。 </li> 
  ...
  <tr> 
   <td colname="col1"> <p> 我是Analytics管理員，無法存取Adobe Admin Console。 誰能幫我進Adobe Admin Console? </p> </td> 
   <td colname="col2"> <p>任何系統或產品管理員只要能存取貴組織的Adobe Admin Console，就能授予您存取權。 如果不確定組織內誰擁有 Admin Console 的管理員權限，請聯絡 <a href="https://helpx.adobe.com/marketing-cloud/contact-support.html">Adobe 客戶服務</a>。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p>我的公司正要移轉至Adobe Admin Console，我該在移轉開始日期前於何處建立新的使用者和權限群組？ </p> </td> 
   <td colname="col2"> <p>在移轉開始日期前，您可以在Adobe Admin Console或Analytics &gt;使用者管理中建立使用者。 </p> <p>移轉開始後，您只能在Adobe Admin Console中建立使用者和權限群組。 </p><p>請參閱下方的「移轉」一節，以詳細了解從移轉開始日期起將會發生的事情。 </p>
   </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> 我何時可以使用 Federated ID 實作單一登入？ </p> </td> 
   <td colname="col2"> <p> Adobe Admin Console即將推出一項工具，可讓您將ID類型從AdobeID變更為Federated ID。 在移轉期間，您無法以 Federated ID 的身分移轉使用者。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_0E37BB1DEA6143F0B5F4E861FCFA7189"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>權限群組如何複製到Adobe Admin Console? 我的使用者又會有什麼改變？ </p> </td> 
   <td colname="col2"> <p>移轉的Analytics群組稱為 <i>產品設定檔</i> 在Adobe Admin Console。 在移轉過程中，系統會保留原始群組的權限設定，但不會移轉指派給群組的使用者。如果是使用移轉工具來移轉屬於該群組的使用者，系統會將使用者指派給該產品設定檔。 </p> <p>舉例來說，West Coast Operations 的某個權限群組授權給成員對 Report Builder 和 Analysis Workspace (以及某些報表套裝、量度、維度) 的使用權，這些群組成員將成為 West Coast Operations 的產品設定檔。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p>移轉開始後，我可以在Analytics中建立使用者和權限群組，然後使用移轉工具將他們移至Adobe Admin Console嗎？ </p> </td> 
   <td colname="col2"> <p> 否。移轉開始後，所有新使用者和權限群組(在Adobe Admin Console中稱為產品設定檔)都必須在Adobe Admin Console中建立。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p>我移轉至Adobe Admin Console的使用者是否仍可繼續透過 <span class="filepath"> my.omniture.com</span>? </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>由於Adobe Admin Console中的使用者帳戶需要不重複的電子郵件ID，因此當您嘗試移轉超過一個這些使用者時，會遇到「重複電子郵件ID」錯誤。 您可以在「使用者管理」(舊版) 區段下更新未移轉使用者的電子郵件 ID，然後重新嘗試移轉。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>移轉工具內含的儀表板，可以顯示有多少使用者已順利移轉，以及其中有多少使用者的舊版登入功能已停用。 </p> <p> 理想情況下，當100%的使用者完成移轉並停用其舊版登入時，您就能將登入公司成功移轉至Adobe Admin Console。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>在移轉期間，我需要執行使用者和授權管理，我可以使用何種工具來執行此工作？ </p> </td> 
   <td colname="col2"> <p>移轉開始後，您將使用Adobe Admin Console建立及管理新的使用者和產品設定檔。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>不可以。您必須使用移轉工具，確保所有現有使用者皆已移轉至Adobe Admin Console。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>哪些Analytics使用者管理功能在Adobe Admin Console中無法使用？ </p> </td> 
   <td colname="col2"> 
    ...
    </ul> <p>您仍然可以在 Analytics 使用者管理中使用這些功能。 </p> <p>請參閱 <a href="/help/admin/admin-console/user-management2/user-migration/c-migration-tool.md"> Adobe Admin Console中不支援的Analytics功能</a> 以取得更多資訊。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>我們在Adobe Admin Console中建立了數個設定，並將它們對應至Analytics權限群組。 移轉開始後，這些設定會發生什麼事？ </p> </td> 
   <td colname="col2"> <p>Analytics權限群組在Adobe Admin Console中重新建立為產品設定檔，就像所有其他群組一樣。 這表示您會在 Admin Console 中看到兩個基本上具有重複權限的產品設定檔。您可以從Adobe Admin Console刪除重複的產品設定檔。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>移轉使用者後的下個步驟是什麼？ </p> </td> 
   <td colname="col2"> <p>在您移轉了特定使用者或一組使用者之後，下一步就是停用他們的 <span class="filepath">my.omniture.com</span> 舊版登入。若要這麼做，您可以在移轉工具中選取使用者，然後按一下顯示在螢幕上方的「停用舊版登入」關聯選項。請注意，只有在您選取已成功移轉至Adobe Admin Console的使用者或一組使用者時，才會顯示此選項。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_F48CC9DFE3424AC9AD76A16882701C8F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>從Adobe Admin Console刪除使用者 </p> </td> 
   <td colname="col2"> <p> 在Analytics中，已刪除的使用者會設為 <span class="term"> 已過期</span>，但帳戶仍會繼續存在。 保留帳戶可以傳送區段、計算量度、排定的報表、專案等資產。 </p> </td> 
  </tr> 
  <tr> 
...
## Adobe Admin Console中不支援的Analytics功能 {#section-928ffba27a0446e0af575b720434ef56}
...
<table id="table_88E2FA03D5F241B79AB54D12F64B51DA"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 移轉至Adobe Admin Console的管理員將無法再使用「登入方式」函式來存取已移轉至Adobe Admin Console的非管理員使用者帳戶。 我們即將從 Analytics 廢除此功能。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>使用者有效期和資產傳送 </p> </td> 
   <td colname="col2"> <p> Adobe Admin Console不支援使用者過期或資產傳輸。 管理員應透過 Analytics「管理工具」底下的「Analytics 使用者與資產」區段執行這兩項功能。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>上次存取 (上次登入) </p> </td> 
   <td colname="col2"> <p> 使用者上次登入日期和時間的詳細資訊，可在Analytics使用者與資產連結中取得，不可在Adobe Admin Console中取得。 Analytics 中的上次登入日期專指使用者實際從 Experience Cloud 存取 Analytics 時的登入日期，而不會反映出使用者登入 Experience Cloud 的日期/時間。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>使用者管理 API <a href="https://helpx.adobe.com/tw/enterprise/help/identity.html">Adobe 支援的身分類型</a> </p> </td> 
   <td colname="col2"> <p> 移轉至Adobe Admin Console的管理員應設定<a href="https://developer.adobe.com/UMAPI/"> 使用者管理API</a> 在Adobe Developer上提供，以程式化存取Adobe Admin Console中的使用者帳戶。 </p> <p>當您為移轉作業啟用此功能時，Analytics 權限 API 將會關閉。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>網站服務憑證 </p> </td> 
   <td colname="col2"> <p> 使用者的網站服務憑證（及其共用機密）將無法在Adobe Admin Console中使用，您可從「Analytics使用者與資產」區段按一下特定使用者來存取。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>單一登入 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Analytics管理工具或Adobe Admin Console將不再支援大量電子郵件給使用者。 客戶可以從 Adobe Admin Console 大量匯出使用者的電子郵件地址，並使用想要的電子郵件用戶端來寄送電子郵件。 </p> </td> 
  </tr> 
 </tbody> 
</table>
