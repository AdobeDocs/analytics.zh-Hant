 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    ...
    </ul> <p>您仍然可以在 Analytics 使用者管理中使用這些功能。 </p> <p>如需詳細資訊，請參閱 <a href="/help/admin/admin-console/user-management2/user-migration/c-migration-tool.md">Adobe Admin Console 中不支援的 Analytics 功能</a>。 </p> </td> 
  </tr> 
  <tr> 
