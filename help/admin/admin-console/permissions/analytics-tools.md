...
| [!UICONTROL 整合 (建立)] | 授與對「管理員 > 所有管理員 > 資料連接器」的存取，並允許使用者建立資料連接器。 |
| [!UICONTROL 整合 (更新)] | 授與對「管理員 > 所有管理員 > 資料連接器」的存取，並允許使用者修改現有連接器設定。 |
| [!UICONTROL 整合 (刪除)] | 授與對「管理員 > 所有管理員 > 資料連接器」的存取，並允許使用者刪除資料連接器。 |
