...
| 功能 | 說明 | [開始推出](releases.md) | [全面發佈](releases.md) |
| ----------- | ---------- | ------- | ---- |
| **串流媒體收集：將Roku資料傳送至Adobe Experience PlatformEdge Network** | 現在，當[使用Experience PlatformEdge](https://experienceleague.adobe.com/zh-hant/docs/media-analytics/using/implementation/edge-recommended/media-edge-sdk/implementation-edge)安裝串流媒體集合時，您可以使用Adobe Experience Platform Roku SDK將串流媒體資料傳送到Adobe Experience Platform。 |  | 2024 年 4 月 12 日 |
