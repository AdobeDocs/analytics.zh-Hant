...
| --- | --- |
| **2025 年 3 月** |  |
| Analytics 庫存 | [Analytics詳細目錄](https://experienceleague.adobe.com/zh-hant/docs/analytics/admin/admin-tools/analytics-inventory)提供您Adobe Analytics環境的完整概觀，包括專案和元件數量、報表套裝、使用者等等。 |
...
| **2023 年 7 月** | |
| ADOBE EXPERIENCE PLATFORM EDGE NETWORK API | 新增有關何時及如何使用[Adobe Analytics Edge Network API](../implement/aep-edge/api/overview.md)透過Adobe Experience Platform實施資料收集的更完整檔案。 例如，在桌面應用程式、IoT 裝置、機上盒中透過 Adobe Analytics 實作資料收集。 |
