...
| 其他訪客身分識別改善 | 新增[訪客身分識別](/help/implement/id/overview.md)區段，概述在所有實作型別中識別訪客的建議方式。 |
| **2025 年 9 月** | |
...
| 調整交易 ID 保留期 | 90 天的交易 ID 保留期已延長至 25 個月交易 ID 變數可唯一識別交易，因此點擊可繫結至透過資料來源上傳的資料。在[此處](/help/implement/vars/page-vars/transactionid.md)和[此處](/help/import/data-sources/transactionid.md)了解更多資訊。 |
...
| 全新 Report Builder 排程功能的全新文檔 | [排程功能](/help/analyze/report-builder/schedule-reportbuilder.md)不僅能讓您安排新的 Report Builder 活頁簿。此外在轉換舊版活頁簿時，也能讓您獲取舊版已排程任務的中繼資料。 |
| Analysis Workspace 中報告 (也稱為範本) 的改進 | 報告 (也稱為[範本](/help/analyze/analysis-workspace/templates/use-templates.md)) 現在提供了各種改善功能： |
...
| 新的 Report Builder | Mac、Windows 和 Web 瀏覽器支援的簡化 Report Builder 增益集的[新文件](/help/analyze/report-builder/rb-overview.md)。 |
| **2024 年 8 月** | |
| 警報管理器 | 簡化了有關 [警報管理器](/help/components/alerts/alert-manager.md) 的文件。清晰度和準確性的更新。 |
| **2024 年 7 月** | |
...
| 資料摘要匯出的安全目標 | 現在可以將資料摘要傳送到以下雲端儲存空間目標：<ul><li>Amazon S3</li><li>Azure RBAC</li><li>Azure SAS</li><li>Google Cloud Platform</li></ul>不再建議使用以前提供的目標 (FTP、SFTP、S3 和 Azure Blob)。[了解更多](/help/export/analytics-data-feed/create-feed.md) |
| Workspace 中的機器人報告 | 機器人報告現在可在 Analysis Workspace 中取得。此功能附帶幾個新增項目：<ul><li>新維度：[機器人名稱](/help/components/dimensions/bot-name.md)</li><li>兩個新量度：[機器人頁面檢視次數](/help/components/metrics/bot-page-views.md)和[機器人發生次數](/help/components/metrics/bot-occurrences.md)。</li><li>一個新的計算量度範本：[機器人頁面檢視次數比率](/help/components/calculated-metrics/cm-reference/default-calcmetrics.md)</li><li>新的工作區報告：機器人報告</li></ul>新維度和量度會包含從 2023 年 3 月開始回填的資料。 |
| **2023 年 5 月** | |
...
| 報告活動管理員 | 更新了這個 beta 文件，尤其是有關[檢視個別報告套裝的報告活動](/help/admin/tools/reporting-activity-manager/reporting-activity-overview.md)的章節。 |
...
| 行動應用程式：自訂詳細資料檢視 | 新的[自訂詳細資料檢視](/help/analyze/mobile-app/create-scorecard.md)主題。 |
...
| --- | --- |
| **2021 年 10 月** |  |
| 2021 年 10 月 21 日 | 有關 Analysis Workspace 中[快速區段](/help/analyze/analysis-workspace/components/segments/quick-segments.md)的新文件。 |
...
| 2021 年 6 月 3 日 | 已更新文件，以便為[資料摘要實作](/help/export/analytics-data-feed/create-feed.md)和[此處](/help/export/analytics-data-feed/df-faq.md#BucketOwnerFullControl)提供更好的說明。 |
| 2021 年 5 月 25 日 | 已更新有關[報告中 eVar 區分大小寫情況](/help/components/dimensions/evar.md)的文件。 |
...
| **2021 年 3 月** | |
| 2021 年 3 月、4 月 | Adobe Analytics 儀表板[執行指南](/help/analyze/mobile-app/executive.md)和[組織者指南](/help/analyze/mobile-app/curator.md)的更新 |
...
| 2020 年 12 月 8 日 | 工作區中「[建立新專案](/help/analyze/analysis-workspace/build-workspace-project/freeform-overview.md)」頁面的更新。 |
| **2020 年 11 月** | |
| 2020 年 11 月 24 日 | 工作區中「[面板概觀](/help/analyze/analysis-workspace/c-panels/panels.md)」頁面的更新。 |
| 2020 年 11 月 24 日 | 新的實作審核文件： <ul><li>[完整實作審核](/help/implement/review/full-review.md)</li><li>[重點實作審核](/help/implement/review/focused-review.md)</li></ul> |
| 2020 年 11 月 24 日 | 已更新 Analysis Workspace 的「[視覺效果概觀](/help/analyze/analysis-workspace/visualizations/freeform-analysis-visualizations.md)」頁面。 |
| 2020 年 11 月 12 日 | 有關[繼承的 Adobe Analytics 實作](/help/implement/prepare/existing-implementation.md)的新頁面。 |
| 2020 年 11 月 2 日 | 已更新有關[用於分類的 FTP](/help/export/ftp-and-sftp/c-set-up-ftp-accounts/ftp-saint.md) 的文件。 |
| **2020 年 10 月** | |
| 2020 年 10 月 23 日 | 工作區線條視覺效果：[移動平均趨勢線選項](/help/analyze/analysis-workspace/visualizations/line.md)：此設定已新增到[!UICONTROL 線條]視覺效果趨勢線設定。移動平均也稱為滾動平均，它會使用特定數量的資料點 (取決於&#x200B;**[!UICONTROL 期間]**&#x200B;選擇)、求取其平均值，並將平均值當做線條中的某個點。 |
| 2020 年 10 月 23 日 | 工作區的[效能說明頁面](/help/analyze/analysis-workspace/workspace-faq/optimizing-performance.md)會顯示影響專案效能的不同因素，以及最佳化秘訣的連結。 |
| 2020 年 10 月 23 日 | 已在 Adobe Analytics 儀表板文件中新增增強功能。現在，在工作區中建立行動計分卡時，計分卡的樣式會與應用程式相符。 |
| **2020 年 9 月** | |
| 2020 年 9 月 17 日 | [下載單一維度的 50K 個項目](/help/analyze/analysis-workspace/curate-share/download-send.md#download-items)：您現在可以在自由表格中下載單一維度的 50,000 個項目，並套用區段和篩選條件。如此一來，您就能存取 Analysis Workspace 以外超過 400 列的資料。 |
...
| **2020 年 8 月** | |
| 2020 年 8 月 31 日 | 已在 Cross-Device Analytics 中的[欄位式銜接文件](/help/components/cda/field-based-stitching.md)中新增增強功能。 |
| **2020 年 7 月** | |
...
| 2020 年 2 月 12 日 | 已在[這個工作區頁面](/help/analyze/analysis-workspace/build-workspace-project/fa-shortcut-keys.md)中新增快速鍵 |
...
| 2019 年 9 月 12 日 | 更新[計算量度總計](/help/components/calculated-metrics/cm-totals.md)文件。 |
| 2019 年 8 月 28 日 | [Analytics 專用漸進式網頁應用程式](/help/technotes/pwa.md)的相關新文章 |
| 2019 年 8 月 8 日 | 新增[計算量度總計](/help/components/calculated-metrics/cm-totals.md)文章 |
| 2019 年 8 月 8 日 | 進一步釐清[啟用時間戳記的作業資料](/help/admin/tools/manage-rs/edit-settings/general/timestamp-configuration.md) |
...
| 2019 年 7 月 18 日 | 有關 Analysis Workspace 中稱為[「Magento：行銷和商務」](/help/analyze/analysis-workspace/build-workspace-project/starter-projects.md)的全新工作區範本的文件。此範本是專為 Magento 電子商務客戶所設計，但所有零售商都可使用此範本來取得有關其商務活動的獨特分析。 |
...
| 2019 年 1 月 17 日 | [同類群組分析](/help/analyze/analysis-workspace/visualizations/cohort-table/cohort-analysis.md) - 同類群組分析的重大改良可讓您：<ul><li>套用區段包含並個別傳回量度。 </li><li>顯示流失率而非保留率。</li><li>顯示延遲表格（包含事件前後的經過時間）。</li><li>自訂同類群組維度(根據eVar而非僅根據時間將訪客分組)。</li><li>執行滾動式同類群組計算：根據先前時段 (而非原始同類群組) 計算保留率/流失率。 </li><li>在包含和回訪欄位中新增多個量度，以及套用區段。 （不支援計算量度）</li></ul> |
