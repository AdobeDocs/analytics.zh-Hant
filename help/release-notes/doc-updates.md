...
| --- | --- |
| **2023 年 11 月** | |
| Activity Map啟用/啟用主題的更新 | 已新增 [Web SDK](https://experienceleague.adobe.com/docs/analytics/analyze/activity-map/getting-started/activitymap-enable.html?lang=en) (手動或透過Adobe Experience Platform標籤擴充功能使用)內容。 |
| **2023 年 10 月** | |
...
| 2019 年 1 月 17 日 | [對 Attribution IQ 中的多值變數的支援](/help/analyze/analysis-workspace/attribution/overview.md)。Analytics 的部分維度可包含單一點擊的多個數值，例如 listVar、產品變數、清單 prop 或銷售 eVar。Analysis Workspace 可讓您將 Attribution IQ 套用至這些點擊層級變數。 |
