...
| --- | --- |
| **2025 年 8 月** | |
| 棄用警告 | 在[分類規則產生器](/help/components/classifications/crb/classification-rule-builder.md)和[分類匯入工具](/help/components/classifications/importer/c-working-with-saint.md)區段的文章中新增取代警告。 |
| **2025 年 7 月** | |
