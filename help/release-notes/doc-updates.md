...
| --- | --- |
| **2025 年 7 月** | |
| 除錯程式 | 新增如何在Analysis Workspace中啟用、使用和停用專案偵錯工具的文章。 |
| 檢閱和更新 | 檢閱和更新Analysis Workspace檔案。 檔案現在會在適當時機與Analysis Workspace上的Customer Journey Analytics檔案同步。 |
| **2025 年 6 月** | |
...
| 「Attribution IQ」已變更為「歸因」 | 將整份文件中所有出現的「Attribution IQ」變更為「[歸因](/help/analyze/analysis-workspace/attribution/overview.md)」。 |
| **2023 年 11 月** | |
...
| 2019 年 9 月 12 日 | [跨裝置分析](/help/components/cda/overview.md)的新檔案 |
