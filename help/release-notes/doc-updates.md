...
* 如需串流媒體收集附加元件的相關資訊，請參閱[在 Analytics 中測量音訊和視訊](https://experienceleague.adobe.com/docs/media-analytics/using/media-overview.html?lang=zh-hant)。
...
| --- | --- |
| **2024 年 8 月** | |
| 警報管理器 | 簡化有關[警報管理員](/help/components/c-alerts/alert-manager.md)的檔案。 清晰度和準確性的更新。 |
| **2024 年 7 月** | |
...
| 改善智慧警報文件 | 更新並改善有關警報的文件。這些更新包括有關[建立警報](/help/analyze/analysis-workspace/c-intelligent-alerts/alert-builder.md)、[管理警報](/help/components/c-alerts/alert-manager.md)的資訊，和[概觀資訊](/help/analyze/analysis-workspace/c-intelligent-alerts/intellligent-alerts.md)。 |
...
| 改善串流媒體收集附加元件的報告文件 | 重新整理串流媒體收集附加元件指南的報告部分中一些內容，包括將 API 文件合併到其部分中，並調整了一些文章順序。 <p>將媒體工作區範本文章重命名為 [Workspace 媒體報告](https://experienceleague.adobe.com/zh-hant/docs/media-analytics/using/media-reports/media-workspace-templates.html)，以與產品內的名稱保持一致。 </p> |
| **2023 年 8 月** | |
