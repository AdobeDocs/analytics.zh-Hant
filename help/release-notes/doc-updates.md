...
* 如需[!UICONTROL Customer Journey Analytics]的相關資訊，請參閱[Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-landing.html?lang=zh-Hant)。
...
| 使用者偏好設定：數字格式 | 您無法在&#x200B;**[!UICONTROL 使用者偏好設定]**&#x200B;的&#x200B;**[!UICONTROL 專案與分析]** > **[!UICONTROL 資料]**&#x200B;區段中定義數字格式。 數字格式是由為登入使用者設定的[預設語言](https://experienceleague.adobe.com/zh-hant/docs/core-services/interface/features/browser-language)自動決定。 |
...
| --- | --- |
| **2025 年 11 月** | |
| 有關 VISTA 規則的重要考量 | 已更新 [Vista 規則](/help/technotes/vista.md)相關的重要考量。 |
| 已新增對話式 AI 工具的資料欄 ID | 已在 ref_type 欄中新增對話式 AI 工具的[資料欄參考 ID](/help/export/analytics-data-feed/c-df-contents/datafeeds-reference.md)。 |
| **2025 年 10 月** | |
...
| 調整交易 ID 保留期 | 90 天的交易 ID 保留期已延長至 25 個月交易 ID 變數可唯一識別交易，因此點擊可繫結至透過資料來源上傳的資料。請參閱[頁面變數](/help/implement/vars/page-vars/transactionid.md)和[資料來源](/help/import/data-sources/transactionid.md)。 |
...
| 2021 年 6 月 3 日 | 已更新檔案，以便更妥善地說明[資料摘要實作](/help/export/analytics-data-feed/create-feed.md)和[BucketOwnerFullControl](/help/export/analytics-data-feed/df-faq.md#BucketOwnerFullControl)。 |
...
| 2019 年 10 月 10 日 | 在工作區中，紫色的顆粒度元件 (分鐘、小時、天、週、月、季、年) 已過時。 如果您先前已使用其中一個紫色時間元件，則&#x200B;**不需要採取任何動作**。<br/>透過這項變更，紫色&#x200B;**[!UICONTROL 時間]**&#x200B;區段也已重新命名為&#x200B;**[!UICONTROL 日期範圍]**。 |
