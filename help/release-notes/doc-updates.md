...
* 如需[!UICONTROL Customer Journey Analytics]的相關資訊，請參閱[Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-landing.html)。
