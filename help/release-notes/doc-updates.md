...
| --- | --- |
| **2026 年 3 月** | |
| 劃分面板 | 已重新建構面板[的](/help/analyze/analysis-workspace/c-panels/panels.md#drop-zone)拖放區域檔案，以支援新的[劃分](/help/analyze/analysis-workspace/c-panels/panels.md#break-down-a-panel)功能。 |
| 已識別新報表套裝的IP模糊化預設選項 | 新增資訊以指出&#x200B;**移除IP位址**&#x200B;是新報表套裝[的預設](/help/admin/tools/manage-rs/edit-settings/general/general-acct-settings-admin.md)IP模糊化選項。 |
| 處理訂單大修 | 大幅改善Adobe Analytics[中的](/help/technotes/processing-order.md)處理順序。 |
