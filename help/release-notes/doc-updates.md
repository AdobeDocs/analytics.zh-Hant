...
| --- | --- |
| **2025 年 9 月** | |
| 訪客身分識別改善 | 釐清有關訪客身分識別的最佳實務，著重於AppMeasurement中[`trackingServer`](/help/implement/vars/config-vars/trackingserver.md)和[`trackingServerSecure`](/help/implement/vars/config-vars/trackingserversecure.md)變數的用途。 |
| **2025 年 8 月** | |
