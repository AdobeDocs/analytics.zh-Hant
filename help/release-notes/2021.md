...
| 功能 | [全面發佈](releases.md) - 目標日期 | 說明 |
| ----------- | ---------- | ------- |
| Workspace：舊版專案 | 2021 年 5 月 20 日 | 讓您載入舊版的 Workspace 專案，以復原不必要的變更或僅是還原成偏好的舊版。 [了解更多](/help/analyze/analysis-workspace/build-workspace-project/save-projects.md#previous-version) |
