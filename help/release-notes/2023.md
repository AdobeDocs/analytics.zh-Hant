...
| 通知 | 新增或更新日期 | 說明 |
| ----------- | ---------- | ---------- |
| **遵循 Google 用戶端提示更新裝置查詢** | 2023 年 2 月 27 日 | 計劃於 2023 年 2 月 16 日使用的用戶端提示已延後，以便進一步確保使用提示的裝置查詢品質。我們將在 2023 年 2 月 27 日進行第一階段發行以支援用戶端提示。如果一切順利，我們將在 2023 年 3 月 2 日星期四繼續第二階段也是最後階段的發行。[了解更多](/help/technotes/client-hints.md) |
