...
| 通知 | 新增或更新日期 | 說明 |
| ----------- | ---------- | ---------- |
| **支援接收模糊化的IP位址** | 2023 年 9 月 27 日 | 將更新來自Experience Edge之點選的IP模糊化功能。 2023年4月，Experience Edge新增了模糊化IP位址的功能。 當時，由於Adobe Analytics處理來自Experience Edge的點選的方式，Analytics僅支援IP的部分模糊化。 客戶選擇Experience Edge使用完全模糊化時，Analytics只會收到部分模糊化的IP。 透過這項變更，Analytics現在將收到完全模糊化的IP。 |
