...
| 通知 | 新增或更新日期 | 說明 |
| ----------- | ---------- | ---------- |
| **更新流量尖峰通知的准則** | 2022 年 11 月 18 日 | 之前的准則嚴格以點擊量為基礎。 此 [新准則](https://experienceleague.adobe.com/docs/analytics/admin/traffic-management/traffic-lead-time.html?lang=en) 是根據報表套裝大小和百分比增加的組合。 |
