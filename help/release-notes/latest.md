...
| 暫停較舊的排程報告 | 2022 年 4 月 12 日 | 自 **2022 年 4 月 21 日**&#x200B;起，Adobe 打算暫停所有建立日期超過兩年的排程報告 (在 2020 年 1 月 31 日之前建立的)。不會刪除任何報表或資料。只有被確認為超過兩年的報表才會被暫停，並且不會發送額外的排程報告。任何建立日期少於兩年且沒有到期日 (或到期日超過兩年) 的報表將套用預設的 9 個月到期日。[了解更多](/help/analyze/reports-analytics/scheduled-reports-eol.md) |
| 2022 ISO 區域更新 | 2021 年 3 月 11 日 | Adobe 將於 **2022 年 6 月 10 日**&#x200B;執行 2022 ISO 區域更新。 預計此版本後將會有較小的地區資訊更新。 |
| 暫停較舊的已排程 Report Builder 工作 | 2022 年 4 月 12 日 | **自 2022 年 4 月 21 日起**，Adobe 打算暫停所有建立日期超過兩年的已排程 Report Builder 工作。這項暫停尤其會套用在 2020 年 1 月 31 日之前建立的任何工作上。 不會刪除任何工作、活頁簿或資料。但是將暫停確認超過兩年的工作，並且不會發送額外的排程工作。[了解更多](/help/analyze/report-builder/r-arb-scheduled-reports.md) |
