...
| ----------- | ---------- | ------- |
| 在 Workspace 中的組合圖表視覺效果 | 組合圖表讓您更輕鬆且直覺地比較在 Workspace 內的指標。[了解更多](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/visualizations/combo-charts.html) | 自 2022 年 9 月 14 日起分階段推出 |
