...
| 設定產品字串變數時，為 Edge 集合使用 XDM 中的 SKU 欄位 | 讓使用Web SDK收集資料的客戶能使用SKU值在產品變數中設定產品欄位。 [了解更多](https://experienceleague.adobe.com/docs/analytics/implementation/vars/page-vars/products.html#products-using-the-web-sdk) | 2022 年 8 月 18 日 |
...
| **透過Adobe Experience Platform Edge Network填入生命週期維度和量度** | 傳送至Edge Network的行動生命週期資料現在會出現在Analytics報告中。 另請參閱 [xdm變數對應](../implement/aep-edge/variable-mapping.md) 以取得詳細資訊。 | 2022 年 5 月 27 日 |
