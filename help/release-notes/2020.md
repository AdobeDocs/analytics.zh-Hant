...
* 修正「未指定」維度無法篩選[!UICONTROL Workspace]欄的問題。 (AN-222393)
...
* 修正已組織之[!UICONTROL 虛擬報表套裝]的問題，此問題仍可依虛擬報表套裝中的任何維度/量度劃分。 (AN-228035)
...
* ([!UICONTROL Customer Journey Analytics])已修正Customer Journey Analytics中共用專案的許可權問題。 (AN-226592)
...
* 修正組織虛擬報表套裝時，造成&#x200B;_元件遺失_&#x200B;錯誤的問題。 (AN-228257)
...
* 修正無法在[!UICONTROL 警報]電子郵件中使用[!UICONTROL 進一步分析]連結的問題。 (AN-226823)
...
* 修正[!UICONTROL 警報]中，_選擇退出此排程_&#x200B;電子郵件連結無法運作的問題。 (AN-223875)
...
| 歸因：自訂回顧期間 | 2020 年 6 月 18 日 | 您現在可以在[!UICONTROL 歸因]中設定任何歸因模型，以納入報表統計時段前最多90天的接觸點。 這通常會計算之前月份的互動，以提高報表統計期間前期所發生之事件的歸因準確度。可供 Adobe Analytics Foundation、Select、Prime、Premium、Premium Attribution、Premium Complete 和 Ultimate 客戶使用。 |
