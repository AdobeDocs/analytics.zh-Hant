...
1. 選取您要複製之資料摘要旁的核取方塊，然後選取&#x200B;[!UICONTROL **複製**]。
   ...
   帶您[使用目前摘要的所有設定來建立新的摘要](create-feed.md)。 如果選取了多個資料摘要，則此選項不會顯示。
...
您可以停止摘要的處理，將其狀態設定為[!UICONTROL 非使用中]。
...
回填摘要（僅處理歷史資料的摘要）會從停止的位置繼續處理資料，如有必要，會回填任何日期。 即時摘要也會從停止的地方繼續處理資料。

>[!AVAILABILITY]
>
>即時摘要繼續處理資料的方式，已在發行的「有限測試」階段進行下列變更：
> 
>**即時摘要從目前時間開始繼續處理資料。**
>
>您的環境中可能尚未提供此變更。
>
>當此變更正式推出時，將會移除此附註。 有關 Analytics 發佈流程的資訊，請參閱 [Adobe Analytics 功能發佈](/help/release-notes/releases.md)。
