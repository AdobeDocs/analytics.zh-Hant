...
| 2019 年 11 月 25 日 | [內部 (工作階段重新整理) 行銷管道](https://docs.adobe.com/content/help/zh-Hant/analytics/components/marketing-channels/session-refresh.html)的相關新主題 |
| 2019 年 11 月 21 日 | 針對[客戶歷程分析](https://docs.adobe.com/content/help/zh-Hant/analytics-platform/using/cja-landing.html)建立的文件 |
| 2019 年 9 月 28 日 | [Javascript 實作的設定變數](https://docs.adobe.com/content/help/zh-Hant/analytics/implementation/javascript-implementation/variables-analytics-reporting/configuration-variables.html)的相關新文章 |
