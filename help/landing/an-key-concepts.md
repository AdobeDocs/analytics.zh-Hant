...
| 產品 | 說明 | 文件連結 |
| --- | --- | --- |
| Analysis Workspace | 用於建立強大、自訂的分析專案，並讓使用者都能自行獲得深入分析的瀏覽器解決方案。提供比「報告與分析」更多的報表彈性 | [分析工作區首頁](/help/analyze/analysis-workspace/home.md) |
| 報告與分析（先前稱為SiteCatalyst） | 用於報告和分析的瀏覽器解決方案。Analytics 套裝中的入門工具。 | [報告與分析首頁](/help/analyze/reports-analytics/getting-started.md) |
...
| Ad Hoc Analysis (前稱為 Discover) | 進階數位分析的 Java 型工具。 | [Ad Hoc Analysis 首頁](/help/analyze/ad-hoc-analysis/adhoc-home.md) |
...
| Adobe Exchange Data Connectors (前身為 Genesis) | 從第三方應用程式匯入追蹤資料至 Analytics，以便在同一中央位置呈現端對端的效能資訊。 | [Data Connectors 首頁](/help/import/data-connectors/data-connectors-eol.md) |
| Dynamic Tag Management (DTM) | 可讓您管理所有網站上的分析、目標及其他標籤，不受網域數目影響。 | [DTM 首頁](/help/implement/other/dtm/dtm-implementation-overview.md) |
...
| 元件 | 您可以拖放至專案上的維度、量度、區段和時間粒度 (日期範圍)。 | [元件](/help/analyze/analysis-workspace/components/analysis-workspace-components.md) |
...
| 客戶歷程報表 | 顯示使用者瀏覽您的網站或應用程式時所採取路徑的相關資訊。Prop、eVar 和事件可在 Analysis Workspace 中使用這項分析。 | [分析工作區流失](/help/analyze/analysis-workspace/visualizations/fallout/fallout-flow.md) <br> [分析工作區流程](/help/analyze/analysis-workspace/visualizations/c-flow/flow.md) <br> [報告與分析路徑](/help/analyze/analysis-workspace/visualizations/c-flow/flow.md) |
...
| 訪客資料 | 協助您瞭解不同資料類別 (包括國家、州、ZIP/郵遞區號和網域) 之客戶的購買模式。 | [訪客資料](/help/components/dimensions/language.md) |
...
| Adobe Exchange Data Connectors | 請參閱 [Analytics 工具](/help/import/data-connectors/data-connectors-eol.md) |  |
...
| 除錯工具選項 | 有數個除錯程式和封包Sniffer可協助驗證您的實作，包括Adobe Experience Cloud除錯程式。 | [Adobe Debugger](https://chrome.google.com/webstore/detail/adobe-experience-cloud-de/ocdmogmohccmeicdhlhhgepeaijenapj?hl=tw) |
