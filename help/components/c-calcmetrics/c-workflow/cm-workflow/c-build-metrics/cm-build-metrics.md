...
| 11 | **產品相容性：**&#x200B;產品相容性會顯示量度是否與<a href="https://experienceleague.adobe.com/docs/analytics/analyze/reports-analytics/current-data.html"  >目前的資料</a>、完整處理的資料相容，或僅與行銷管道報告 (首次接觸配置) 相容。 <p>附註：目前的資料並未支援所有量度。包含細分群體或函數的量度與目前的資料不相容。<a href="/help/components/c-calcmetrics/cm-compatibility.md"  > 更多... </a> </p> </p> |
...
| 18 | **細分群體清單：**(僅限進階計算量度) 身為管理員，此清單會顯示在您的登入公司中建立的所有細分群體。如果您不是管理員使用者，此清單會顯示您擁有以及與您共用的細分群體。<a href="https://experienceleague.adobe.com/docs/analytics/components/segmentation/segment-reference/seg-rights.html"  > 更多... </a> |
