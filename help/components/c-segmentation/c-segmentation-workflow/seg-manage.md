...
title: 管理區段
topic: 區段
uuid: 47d54822-a662-471d-8dab-03ddf6 c2 f395
...
* 顯示現有報表並按一下左側導覽中的區段圖示 ![。](assets/segment_icon.png)Then click **[!UICONTROL Manage]**.

## 作法影片 {#section_B3C5DA22DC5248DBA17C56E03DA2D4F2}

此 [Adobe Analytics YouTube 影片](https://www.youtube.com/watch?v=CdfOq98PTrg&index=6&list=PL2tCx83mn7GtHqZicFTa--aE6d02BvvTd)提供如何使用區段管理員的簡短概述。
...
## Ad Hoc Analysis 中的區段管理員 {#section_CC8BDC968EBC4BC1919870869D8443A9}
...
如同 Web 使用者介面中的「區段管理員」，此主控台提供多項功能，包括區段共用、篩選、標記、核准、複製、刪除和標記為我的最愛。
