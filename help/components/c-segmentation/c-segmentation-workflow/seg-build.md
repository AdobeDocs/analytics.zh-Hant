...
* **[!UICONTROL Analysis Workspace]**: 按一下&#x200B;**[!UICONTROL 「Analytics]** &gt; **[!UICONTROL Workspace」]**，開啟一個專案並按一下&#x200B;**[!UICONTROL 「+ 新增]** &gt; **[!UICONTROL 建立區段」]**。
...
* **[!UICONTROL Report Builder]**: [在 Report Builder 中新增或編輯區段](https://marketing.adobe.com/resources/help/en_US/arb/segmentation.html)。
...
1. **[!UICONTROL 標記]**: [標記您建立中的區段](/help/components/c-segmentation/c-segmentation-workflow/seg-workflow.md)，方法為選擇現有標記清單中的標記或是建立新標記。
...
1. 在&#x200B;**[!UICONTROL 標記]**&#x200B;底下，選取現有標記或建立新標記來[標記](/help/components/c-segmentation/c-segmentation-workflow/seg-tag.md)容器。
