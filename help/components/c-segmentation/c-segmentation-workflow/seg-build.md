...
1. **[!UICONTROL Experience Cloud發佈]**: 將Adobe Analytics區段發佈至Experience Cloud可讓您在其他啟動通道中使用該區 [!DNL Audience Manager] 段進行行銷活動。 [更多詳情...](/help/components/c-segmentation/c-segmentation-workflow/seg-publish.md)
