...
請參閱 [關於區段](/help/components/segmentation/seg-overview.md) 以取得快速概述。 然後前往 [設定細分工作流程](/help/components/segmentation/segmentation-workflow/seg-workflow.md) 或 [建立區段](/help/components/segmentation/segmentation-workflow/seg-build.md).
