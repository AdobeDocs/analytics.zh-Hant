...
2. 按一下 **[!UICONTROL 共用]** ![](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Share_18_N.svg).
...
3. 您可以依已共用給您的區段來篩選，方法是前往&#x200B;**[!UICONTROL 「篩選]**」>「**[!UICONTROL 其他篩選器]**」>「**[!UICONTROL 已共用給我]**」。
