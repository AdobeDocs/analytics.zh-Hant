...
1. Click **[!UICONTROL Edit Settings]** &gt; **[!UICONTROL Marketing Channels]** &gt; **[!UICONTROL Marketing Channel Manager]**.
   ...
   >[!NOTE]
   >
   >The [!UICONTROL Marketing Channels: Auto Setup] page displays automatically when you access channel configuration applications in Admin Tools. (See [Marketing Channel Manager](/help/components/c-marketing-channels/c-channels.md).) 如果報表套裝中包含一個或多個行銷渠道，該頁面不顯示。除非選擇其他不包含行銷渠道的報表，否則無法再存取該頁面。
