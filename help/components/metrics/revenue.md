...
「收入」[量度](overview.md)會顯示所有訂單中購買產品的金額。 此量度對電子商務網站衡量轉換成效至關重要。 您可以將此量度與任何維度結合，瞭解哪些維度專案對收入有貢獻。 例如，您可以看到前幾名的行銷活動 (使用[追蹤代碼](../dimensions/tracking-code.md)維度)，或前幾名的內部搜尋詞彙 (使用 [eVar](../dimensions/evar.md))。
