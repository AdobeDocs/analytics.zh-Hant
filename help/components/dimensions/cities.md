...
「城市」 [維度](overview.md) 報表點選源自的城市。 此維度有助於判斷訪客在造訪您的網站時最常來自哪些城市。您可以利用這些資料加強這些城市的當地廣告，例如廣告看板或商業廣告。

## 將資料填入此維度中

此維度會參考 Adobe 內部的查閱規則。查閱值以隨著點擊傳送的 IP 位址為基礎。Adobe 與 [Digital Element](https://www.digitalelement.com/) 合作，共同維護 IP 位址與城市之間的查閱。
