...
「地區」維度會報告訪客的地理區域。這是小於國家/地區、大於城市的地理區域。在某些國家，地區是指一個州、省或府/州。在其他區域，則是指構成國、部門或都會區。如果您想要有比[國家/地區](countries.md)更精細、但比[城市](cities.md)粗略的深入分析，使用此維度將有所幫助。
...
維度項目包含地區和地區所在的國家/地區。範例值包括 `"California (United States)"`、`"Tokyo (Japan)"` 或 `"Sao Paulo (Brazil)"`。
