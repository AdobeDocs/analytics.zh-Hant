...
* 區段的任何限制也適用於虛擬報表套裝
   ...
   虛擬報表套裝不過是套用到報表套裝的區段。由於每個報表套裝都有其專屬的Data Warehouse和資料饋送，因此使用多個報表套裝會產生區段無法提供的某些優點。
* 即時報表
* 無法像在完整報表套裝中一樣自訂設定和變數名稱

## 虛擬報表套裝與多套裝標籤 {#section_317E4D21CCD74BC38166D2F57D214F78}
