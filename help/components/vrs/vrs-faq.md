...
| 如何找到虛擬報告套裝 ID？ | <ul><li>透過開啟 Workspace 專案、按一下報告套裝選擇器並在搜尋方塊中搜尋虛擬報告套裝的名稱。 ID 會顯示在搜尋結果中的名稱下方：<br>![](assets/vrs-id.png)</li><li> 或者，以程式設計方式，顯示在[虛擬報告套裝 API](https://www.adobe.io/apis/experiencecloud/analytics/docs.html#!AdobeDocs/analytics-2.0-apis/master/vrs.md) 中。</li></ul> |
