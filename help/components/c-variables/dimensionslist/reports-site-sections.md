...
* 此報告會直接參照來自於網站上實作之 [s.channel](https://docs.adobe.com/content/help/zh-Hant/analytics/implementation/vars/page-vars/channel.html) 變數的資料。
* 此報告可使用趨勢與排名格式來檢視。
* 此報告可使用搜尋篩選器尋找特定明細項目。
...
* 此報告可使用下列量度：
   ...
   * **頁面檢視**：[pageName](https://docs.adobe.com/content/help/zh-Hant/analytics/implementation/vars/page-vars/pagename.html) 變數或 URL 已定義 (設為預設量度) 的次數
