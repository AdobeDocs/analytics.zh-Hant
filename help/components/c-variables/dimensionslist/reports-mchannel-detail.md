...
這些報告可提供您網站上最有效之特定促銷活動或關鍵字的分析。您可使用此報告來分配成功量度和收入至各種管道的詳情，無需考慮整體管道情形。例如，您可以將某個付費搜尋關鍵字與某個電子郵件促銷活動進行比較。相對於「行銷管道概觀」報表，此報表更類似標準報表。
...
* *首次接觸*&#x200B;和&#x200B;*上次接觸*&#x200B;之間的差異位於[關於行銷管道報表](/help/components/c-marketing-channels/analyze-mc.md)中。
