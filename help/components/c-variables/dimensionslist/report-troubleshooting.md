...
>但不適用於 Analysis Workspace，Analysis Workspace 有其專屬的一套[最佳實務](/help/analyze/analysis-workspace/workspace-faq/optimizing-performance.md)。這些建議也不適用於 Data Warehouse [最佳實務](https://docs.adobe.com/content/help/zh-Hant/analytics/export/data-warehouse/data-warehouse-bp.html)。此外，
