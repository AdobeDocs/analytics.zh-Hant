...
為了協助您建立有效的資料檔案，您可以下載範本檔案，它能提供檔案結構以供您將分類資料貼入。有關詳細資訊，請參閱[下載分類範本](/help/components/classifications/c-classifications-importer/c-download-saint-data.md)。

請參閱[一般檔案結構](/help/components/classifications/c-classifications-importer/c-saint-data-files.md)，取得關於分類中字元限制的相關資訊。

請參閱[數值 2 分類](/help/components/classifications/c-numeric-2/c-numeric-2-classifications.md)，取得使用數值 2 分類上傳資料的相關資訊。
...
* 可以在儲存格中內嵌定位字元、新行字元和引號等特殊字元，前提是已指定 v2.1 檔案格式且儲存格已正確[逸出](/help/components/classifications/c-classifications-importer/t-classifications-escape-data.md)。特殊字元包括：
...
* 資料檔案的第一個資料行 (非註解) 含有識別該欄之分類資料所用的欄標題。匯入工具須有特定的欄標題格式。有關詳細資訊，請參閱[欄標題格式](/help/components/classifications/c-classifications-importer/c-saint-data-files.md)。
...
<table id="table_0548F2E58B6644208147434EB9B3C21B"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>要求 Adobe 自動為此元素產生唯一 ID。 </p> <p>在促銷活動內容中，此控制值能指示 Adobe 將識別碼指定給每個創作元素。請參閱 <a href="/help/components/classifications/c-classifications-importer/c-saint-data-files.md"  > 金鑰 </a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>~period~ </p> </td> 
   <td colname="col2"> <p>指出資料欄代表與項目相關的資料範圍。請參閱 <a href="/help/components/classifications/c-classifications-importer/c-saint-data-files.md"  > 日期 </a>。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>指出資料欄代表 <span class="wintitle">PER 修飾詞</span>欄位。請參閱 <a href="/help/components/classifications/c-classifications-importer/c-saint-data-files.md"  >PER 修飾詞標題</a>。 </p> </td> 
  </tr> 
 </tbody> 
</table>
