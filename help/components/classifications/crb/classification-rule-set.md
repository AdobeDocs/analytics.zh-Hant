...
<table id="table_A5D92409969747E39E041216A5AA32CD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 顯示規則集中包含的規則數目。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>狀態 </p> </td> 
   <td colname="col2"> 顯示規則集的活動狀態，例如「草稿」或「作用中」。 作用中規則會每天處理，檢查通常一個月後傳回的分類資料。 規則會自動檢查新值並上傳分類。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>上次變更時間 </p> </td> 
   <td colname="col2"> 表示編輯規則集的時間。 </td> 
  </tr> 
  <tr> 
