...
>
>| Analytics資料中心位置 | 將此IP位址範圍新增至您網路的允許清單 |
>|---|---:|
>| 太平洋西北地區 | `52.254.104.0/22` |
>| 倫敦 | `51.138.0.0/19` |
>| 新加坡 | `20.32.0.0/11 ` |
>
...
1. 若要選取雲端位置，請從&#x200B;**[!UICONTROL 位置帳戶]**&#x200B;中選取選項。 只會顯示允許匯入分類資料[&#128279;](https://experienceleague.adobe.com/zh-hant/docs/analytics/components/locations/configure-import-accounts)之支援帳戶型別的位置帳戶。 若要建立新帳戶，請選取&#x200B;**[!UICONTROL 新帳戶]**。
...
| 日期 | 動作 |
|---:|---|
| 5/1/26 | 標題為`import.csv`的檔案已上傳至雲端儲存空間。 |
| 5/1/26 | 檔案已處理（檔案存在時間少於30天，且之前未處理）。 |
| 5/28/26 | 檔案&#x200B;**未**&#x200B;已處理（檔案的存留時間少於30天，但已在過去30天內處理）。 |
| 6/15/26 | 檔案&#x200B;**未**&#x200B;已處理（檔案自其上次修改日期/上傳日期以來已超過30天）。 |
| 6/16/26 | 已對標題為`import.csv`的相同檔案進行更新，並已上傳至雲端儲存空間。 |
| 6/16/26 | 會處理更新的檔案（更新的檔案在30天內且先前未處理過更新的檔案）。 |
| 6/30/26 | 更新的檔案已&#x200B;**未**&#x200B;處理（更新的檔案在30天內已處理，但在過去30天內已處理）。 |
| 7/31/26 | 更新的檔案已&#x200B;**未**&#x200B;處理（更新的檔案自其上次修改日期/上傳日期以來已超過30天）。 |
