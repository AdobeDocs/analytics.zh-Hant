...
您想要定義規則，以便在關鍵維度「內部行銷活動」的值開頭為`em`時（例如： `em:FY2025:Summer Sale`），將`Email`指派為&#x200B;**[!UICONTROL 管道]**&#x200B;分類的值。
...
當索引鍵維度「內部行銷活動」的值包含`2025`時（例如： `em:Summer Sale:FY2025`），您要定義規則以將`2025`指派為&#x200B;**[!UICONTROL Year]**&#x200B;分類的值。
...
您想要定義一個規則，以根據`:` **[!UICONTROL Token]**&#x200B;將關鍵維度Internal Campaign的值分割為&#x200B;**[!UICONTROL Channel]**、**[!UICONTROL Type]**&#x200B;和&#x200B;**[!UICONTROL Year]**&#x200B;分類。
