...
+ 維度 {#dimensions}
   ...
   + [維相容性](dimensions/compatibility.md)
   ...
   + [促銷活動](dimensions/campaigns.md)
   + [類別](dimensions/category.md)
   + [城市](dimensions/cities.md)
   + [色彩深度](dimensions/color-depth.md)
   + [連接類型](dimensions/connection-type.md)
   + [Cookie支援](dimensions/cookie-support.md)
   + [國家](dimensions/countries.md)
   ...
   + [年份](dimensions/day-of-year.md)
   + [日](dimensions/day.md)
   + [首次購買前幾天](dimensions/days-before-first-purchase.md)
   ...
   + [上次接觸渠道](dimensions/last-touch-channel.md)
   + [上次接觸渠道的詳情](dimensions/last-touch-detail.md)
   + [行銷渠道](dimensions/marketing-channel.md)
   + [分鐘](dimensions/minute.md)
   + [行動裝置尺寸](dimensions/mobile-dimensions.md)
   ...
   + [單頁瀏覽](dimensions/single-page-visits.md)
   ...
   + [追蹤退出原因](dimensions/tracking-opt-out-reason.md)
   + [US DMA](dimensions/us-dma.md)
   + [美國各州](dimensions/us-states.md)
   + [瀏覽深度](dimensions/visit-depth.md)
   + [瀏覽次數](dimensions/visit-number.md)
...
+ 量度 {#metrics}
   ...
   + [每次瀏覽的平均頁面檢視次數](metrics/average-page-views-per-visit.md)
   + [平均作業長度](metrics/average-session-length.md)
   + [網站平均逗留時間](metrics/average-time-on-site.md)
   + [反彈率](metrics/bounce-rate.md)
   + [彈回數](metrics/bounces.md)
   ...
   + [行動裝置檢視](metrics/mobile-views.md)
   + [新增參與](metrics/new-engagements.md)
   + [發生次數](metrics/occurrences.md)
   + [每次存取訂購](metrics/orders-per-visit.md)
