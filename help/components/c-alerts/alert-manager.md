...
seo-title: 警報管理器
title: 警報管理器
uuid: 6c227854-af8 b-4ff2-ae88-9ca7 ddBee242
...
* 複製警報。
* 啟用/停用警報。
* **更新**&#x200B;警報到期日。When one or more alerts are selected, they can be renewed by clicking **[!UICONTROL Renew]**.This extends their expiration dates to be 1 year from the day **[!UICONTROL Renew]** was clicked, regardless of their original expiration date.
* 將警報匯出為 .CSV 檔案。
* 按兩下警報標題以編輯警報。
* 搜尋警報。
* 新增警報至其他報表套裝。
