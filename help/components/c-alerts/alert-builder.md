...
1. 指定下列選項來設定警示：
   ...
   | [!UICONTROL **預覽**] | 互動式警報預覽會根據過去經驗，顯示觸發警報的大約頻率。<p>例如，如果您將時間詳細程度設為每日，則預覽可告訴您在過去 30 或 31 天裡，針對某個量度觸發了 x 次警報。</p><p>如果您發現將觸發的警報過多，可在[警報管理員](/help/components/c-alerts/alert-manager.md)中調整臨界值。</p><p>![](assets/alert_preview.png)</p> |
