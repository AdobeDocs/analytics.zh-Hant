...
警報管理員的結構類似於[區段管理員](/help/components/segmentation/segmentation-workflow/seg-manage.md)和[計算量度管理員](/help/components/calculated-metrics/workflow/cm-manager.md)。
