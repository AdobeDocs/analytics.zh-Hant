...
keywords: Analytics實作；流量prop；prop；轉換；evar；s. prop；自訂轉化見解；流量變數
seo-description: 自訂流量變數 (也稱為 prop (s.prop) 或屬性變數) 是一種計數器，會計算每個值傳入 Analytics 中的次數。
seo-title: prop和eVar的概述
solution: Analytics
title: prop和eVar的概述
topic: 開發人員和實施
uuid: 522cab2b-1ef8-4f10-b216-c82 b21431487
...
>[!NOTE]
>
>[!DNL Analytics] 最多可支援75 [!UICONTROL s. prop] 變數。
