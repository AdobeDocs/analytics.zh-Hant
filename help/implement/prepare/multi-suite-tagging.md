---
description: 了解如何實施多套裝標記，以傳送影像要求給多個報告套裝。
title: 實作多套裝標記
...
* 若為其他實施類型，請使用列出多個 RSID 所需的語法。

>[!TIP]
>
> 最佳做法是先列出全域報表套裝或報表套裝 ID。

多套裝標記會導致每個影像要求有多個伺服器呼叫：對全域報告套裝發出主要要求，並對每個子報表套裝發出次要要求。
...
使用虛擬報告套裝來取代多套裝標記通常是最佳做法，但您的業務需求會決定最適合貴組織的報告套裝做法。
