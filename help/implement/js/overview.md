---
title: 使用適用於JavaScript的AppMeasurement實作Adobe Analytics
...
# 使用適用於JavaScript的AppMeasurement實作Adobe Analytics
...
![如何透過AppMeasurement for Javascript實作Adobe Analytics，如本節所述。](../assets/appmeasurement-annotated.png)
...
<tr>
<td>1</td><td>確定您已<b>定義報表套裝</b></td><td><a href="../../admin/tools/manage-rs/report-suites-admin.md">報表套裝管理員</a></td>
</tr>

<tr>
<td>2</td><td><b>從代碼管理器下載AppMeasurement</b>所需的JavaScript代碼。 解壓縮檔案。</td><td><a href="../../admin/tools/code-manager-admin.md">程式碼管理員</a></td>
</tr>
