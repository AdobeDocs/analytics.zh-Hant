...
* **與 Experience Cloud ID Service 不相容**：自從跨裝置訪客身分識別功能問世以來，Adobe 已推出功能更強大、更可靠的方式來跨裝置追蹤訪客。這些新的身分識別方法與自訂訪客 ID 覆寫不相容。如果您打算使用ID服務、跨裝置分析(CDA)或Device co-op,Adobe強烈建議不要使用`visitorID`變數。
