...
>[!IMPORTANT]
>
>動態帳戶僅支援使用舊版 JavaScript 實施作業 (H 程式碼)。 目前的 AppMeasurement 程式庫或 Adobe Experience Platform 中的標記不支援這些變數。
...
* 在透過網頁型翻譯引擎 (例如 Google) 翻譯頁面時，動態帳戶選取功能無法如預期運作。 如需更精確的追蹤，請在伺服器端填入`s_account`變數。
