...
2. 使用資料層填入 Analytics 變數。如果您使用 Adobe Experience Platform 中的標記，可以藉由使用資料元素，然後將資料元素指派給變數來輕鬆完成這項工作。 請參閱「[資料元素](https://experienceleague.adobe.com/docs/experience-platform/tags/ui/data-elements.html?lang=zh-Hant)」。
