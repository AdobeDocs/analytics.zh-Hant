...
此外掛程式提供完善的功能，可剖析複雜的 URL，包括雜湊和包含多個查詢字串參數的 URL。如果您只需要簡單的查詢字串參數，Adobe建議使用URL參數功能，使用Web SDK或Adobe Analytics副檔名或 [`Util.getQueryParam()`](../functions/util-getqueryparam.md) 方法。
