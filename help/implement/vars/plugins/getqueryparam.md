...
此外掛程式提供完善的功能，可剖析複雜的 URL，包括雜湊和包含多個查詢字串參數的 URL。如果您只有簡單的查詢字串參數需求，Adobe 建議您使用 Adobe Experience Platform 中的標記或 AppMeasurement 中所包含的 [`Util.getQueryParam()`](../functions/util-getqueryparam.md) 方法來使用 URL 參數功能。
