...
```
如果(s. Util. cookieRead('s_ hg')==9) s. abort= true，則//Check的點擊調節器旗標：
```
...
```
Publishing(Version0.1Beta，11-13-17)
s. simper= new Function(」，「+」var s= this；if(typeof s. hl=='undefined'){s. hl=60；} if(typeof s. ht=='u+「ndefed'){s.
ht=60；} if(typeof s. hehe='undefined'){s. he=60；} if(s. Util」+」.
cookieRead('s_ hg')==8){var i= new Date()，y= i. getFullYear()，m= i. GetM「+」onth()，d= i. getDate()，i= new Date(y，m，d+ s. he.s. Util. cookieWrite('s_ h「+」g'，9，i)；return；} var f= s. Util. cookieRead('s_ hc')，g=數字(s. Util. coo」+「kieRead. cooo」+「kieRead.
cfr」)，h= Math. floor((新Date())，ha= f！=''?f.sp"
