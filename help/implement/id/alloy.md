...
身分資料可以延伸，以使用XDM的[`identityMap`](https://experienceleague.adobe.com/zh-hant/docs/experience-platform/collection/identity/identity-map)支援自訂ID和多個名稱空間。 Adobe建議使用ECID作為Analytics的主要識別碼，並針對進階案例使用其他識別管理選項。
