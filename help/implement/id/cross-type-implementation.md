...
| Experience Cloud ID 服務 | [原生包含](web-sdk-extension.md) | [原生包含](alloy.md) | 使用[Experience Cloud ID服務擴充功能](analytics-extension.md) | 實作 [`VisitorAPI.js`](appmeasurement.md) | 對ID服務[&#128279;](https://experienceleague.adobe.com/en/docs/id-service/using/implementation/direct-integration)進行個別呼叫以取得所需的ID，並將`mid`納入查詢字串中 |
