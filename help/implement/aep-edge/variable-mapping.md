...
| `_experience.analytics.customDimensions.`<br/>`lists.list1.list[].value` -<br/>`_experience.analytics.customDimensions.`<br/>`lists.list3.list[].value` | 全部連接 `value` 每個相應的字串 `list[]` 陣列 [清單變數](../vars/page-vars/list.md)。 |
