...
>[!NOTE]只有具備管理員權利的使用者才能建立屬性。如需角色的相關詳細資訊，請參閱 Dynamic Tag Management 產品文件中的[在 DTM 中建立及管理群組](https://docs.adobe.com/content/help/zh-Hant/dtm/using/admin/groups.html)。
