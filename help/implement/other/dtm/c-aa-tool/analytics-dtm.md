  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b>自動</b> (建議)：使用動態標籤管理來管理配置。此方法可讓您透過 <span class="keyword">Experience Cloud</span> 登入或 Web 服務 ID 來自動同步 <span class="keyword">Adobe Analytics</span> 報表套裝，並管理 AppMeasurement 程式碼。 </p> <p>帳戶連線之後，Dynamic Tag Management 會將 <span class="keyword">Adobe Analytics</span> 報表套裝 ID 和名稱提取至工具設定介面，讓工具部署的速度增加，並降低使用者錯誤的可能性。 </p> <p> <p>注意：如果您是 <span class="wintitle">Adobe Analytics Premium</span> 客戶，則必須選擇<span class="keyword">自動</span>選項。 </p> </p> <p>填寫自動配置的特定欄位： </p> 
    <ul id="ul_8D9797B01E444B9C85B862A9F96B447C"> 
     <li id="li_0AC84C1F37B24C658F2178E50ECCC4B0"> <p> <b>Experience Cloud</b>：(預設) 使用 <span class="keyword">Experience Cloud</span> 單一登入。指定您的Experience Cloud ID和密碼。 </p> </li> 
...
1. 視需要編輯欄位。
   ...
   下表僅包含與您建立Analytics工具時可用元素不同的元素，如上所述。 但是，您可以變更頁面上的任何元素，如兩表所述。
...
<table id="table_2B60CD109CFF4839AB7F91D61125EDFF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>啟用此設定會將手動配置實施變更為自動設定方法，如<span class="term">設定方法</span>所述。 </p> <p>此選項允許 Dynamic Tag Management 自動擷取您 <span class="keyword">Adobe Analytics</span> 帳戶的設定。 </p> <p>會使用最新可用的 AppMeasurement 程式碼，並在新版本可用時顯示升級通知以供選擇。您也可以視需要回滾至舊版AppMeasurement，例如出於相容性原因。 最多會顯示五個先前的版本。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>更新認證 </p> </td> 
   <td colname="col2"> <p>重新整理API，例如，更新與使用者關聯的報表套裝。 </p> </td> 
  </tr> 
 </tbody> 
</table>
