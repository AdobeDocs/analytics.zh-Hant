...
如果訪客在 Floodlight 伺服器追蹤點按之後並未實際進入著陸頁面，則不算是點進。有些廣告和實施實際上不一定會使訪客的瀏覽器遵循 302 重新導向。關於此主題的深入討論，請參閱[協調量度差異](../dfa-data-connector-analytics/dfa-reconciling-metric-discrepancies.md)。
