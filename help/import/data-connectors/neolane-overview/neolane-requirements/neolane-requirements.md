...
* **可用且已設定的Adobe Analytics變數：** 此項整合需要自訂事件和自訂eVar，以及選擇性的其他事件和其他eVar。請參閱 [Adobe Analytics整合變數](../../neolane-overview/neolane-requirements/neolane-variables.md#concept-8ebd2bde4a1c4b0aad2987e050ffbbfc)。
