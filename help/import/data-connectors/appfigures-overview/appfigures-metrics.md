...
<table id="table_504271ED1A954CCAA234738B07EDDF27"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 平均應用程式分級。此計算度量是使用下列公式定義： <code> [App&amp; amp；nbsp；商店與電子郵件；nbsp；評分]與amp；nbsp；/amp；nbsp；[App&amp; amp；nbsp；商店與電子郵件；nbsp；分級與amp；nbsp；Divisor] </code> </td> 
  </tr> 
 </tbody> 
</table>

## 每個AppFigures度量的相關維度 {#section-cd356d3dce04412893beed345305c247}
