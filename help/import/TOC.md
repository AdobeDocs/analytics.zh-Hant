...
+ 資料來源 {#data-sources}
   ...
   + 資料類型與類別 {#data-types-and-categories}
      + [資料類型與類別概觀](c-data-sources/c-datasrc-types/datasrc-categories.md)
      + [網頁記錄](c-data-sources/c-datasrc-types/datasrc-web-log.md)
      ...
      + [完整處理終止服務](c-data-sources/c-datasrc-types/datasrc-fullproc-eol.md)
