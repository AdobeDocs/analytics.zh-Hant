...
* **可用且已設定的Analytics變數：** 此項整合需要個自訂事件和個自訂eVar，以及選擇性的個額外事件和個額外的eVar。See [Analytics Integration Variables](../../silverpop-overview/silverpop-variables.md#concept-6c8a359719fd4794a42f5f6fb118f8b2).
