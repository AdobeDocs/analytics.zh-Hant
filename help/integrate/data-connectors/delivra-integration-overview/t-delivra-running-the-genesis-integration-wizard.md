...
<table id="table_74EC1EEBE7A548AB878AA40187EBCD30"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col3"> <p>Select <b>JavaScript Plug-in</b> if you want to use the plug-in as the collection model for this integration, then click <b>Next</b> to proceed to Step 7 of the Wizard. </p> <p> <p>注意：「自動化解決方案」是預設選擇。 </p> </p> <p>請連絡您的Adobe顧問，取得用於此整合的JavaScript外掛程式副本。You can also copy and paste the plug-in contained in <a href="delivra-plug-in-code.md#concept_28E7C834A6804A949AA9306F8896B36E" type="concept" format="dita" scope="local"> Analytics Plug-In Code</a>. </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td colname="col1"> <p>6 </p> </td> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col3"> <p>Click <b>Finish</b> to complete the integration. </p> <p><b>重要：</b> 在您按一下 <b>「完成」</b>後，Analytics才會儲存整合設定。 </p> </td> 
  </tr> 
 </tbody> 
</table>
