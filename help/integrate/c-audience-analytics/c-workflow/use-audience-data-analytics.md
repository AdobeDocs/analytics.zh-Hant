...
1. 從清單中 **[!UICONTROL Dimensions]**&#x200B;選擇維 **[!UICONTROL Audience ID]** 或 **[!UICONTROL Audience Name]**。 名稱為易記的 ID 分類方式。
...
1. 在功能表 [!UICONTROL Audiences Name] 中搜尋 **[!UICONTROL Component]** 項目。
...
1. 按一下 **[!UICONTROL Build]**.
1. (選用)：將任何其他維度拖曳至「流量」視覺效果可建立[維度間流量](https://docs.adobe.com/content/help/en/analytics/analyze/analysis-workspace/visualizations/flow/multi-dimensional-flow.html)。
...
[文氏圖表視覺效果](https://docs.adobe.com/content/help/en/analytics/analyze/analysis-workspace/visualizations/venn.html)可顯示最多 3 個區段之間的重疊部分。

1. Go to **[!UICONTROL Workspace]** and select the **[!UICONTROL Venn]** visualization from the left rail.

1. 在元件 [!UICONTROL Audience Name] 菜單中搜索。
...
您可以將「對象」維度連同 Analytics 收集的行為資訊整合到 Analytics [區段產生器](/help/components/c-segmentation/c-segmentation-workflow/seg-build.md)。
...
1. 若要檢視Analytics報表，請前往 **[!UICONTROL Reports]** > **[!UICONTROL Visitor Profile]** > **[!UICONTROL Audience ID Reports]** 。
