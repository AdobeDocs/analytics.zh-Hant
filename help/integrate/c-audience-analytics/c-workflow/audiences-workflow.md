...
| 步驟 3 | [在 Analytics 中使用資料](/help/integrate/c-audience-analytics/c-workflow/use-audience-data-analytics.md)。 | 您可以在Analysis Workspace及其相關功能（區段比較、流量、文氏圖表等）中使用新的Adobe Audience Manager對象維度。 <br>「對象」維度也適用於 Reports &amp; Analytics、Report Builder、Data Warehouse 及「資料摘要」。<br>**注意**：「資料摘要」僅包含「對象 ID」，不含「對象名稱」。 |
