...
| 步驟 3 | [在 Analytics 中使用資料](/help/integrate/c-audience-analytics/c-workflow/use-audience-data-analytics.md)。 | 您可以在Analysis Workspace中使用新的「Adobe Audience Manager對象」維度及其相關功能（「區段比較」、「流量」、「文氏圖表」等）。 <br>Report Builder、Data Warehouse和資料摘要中也提供「對象」維度。 <br>**注意**：「資料摘要」僅包含「對象 ID」，不含「對象名稱」。 |
