...
user-guide-description: 設定與其他Adobe CX企業解決方案（例如Audience Manager和Advertising）的整合。
...
+ Audience Analytics {#audience-analytics}
   ...
   + Audience Analytics 工作流程 {#audience-analytics-workflow}
      ...
      + [建立Analytics目的地 — Adobe Audience Manager指南](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/destinations/experience-cloud-destinations/create-analytics-destination.html?lang=zh-Hant)
...
+ [適用於Advertising的Adobe Analytics](https://experienceleague.adobe.com/docs/advertising-cloud/integrations/analytics/overview.html?lang=zh-Hant)
+ [適用於Target的Adobe Analytics - A4T](https://experienceleague.adobe.com/docs/target/using/integrate/a4t/a4t.html?lang=zh-Hant)
