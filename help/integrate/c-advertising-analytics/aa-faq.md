...
+++ 我需要是Adobe Advertising客戶才能存取這項功能嗎？

否，此功能適用於非Advertising客戶。 Adobe Advertising客戶可以利用現有的Analytics + Advertising整合。
...
+++ 如果我已經使用Adobe Advertising，還可以使用Advertising Analytics功能嗎？

任何相容的搜尋引擎帳戶都會傳入Advertising Analytics，並顯示為唯讀。 所有編輯或更新都應在Advertising中處理。
...
Advertising Analytics運用一系列自訂API，將資料從搜尋引擎透過Adobe Advertising傳遞至Adobe Analytics。
