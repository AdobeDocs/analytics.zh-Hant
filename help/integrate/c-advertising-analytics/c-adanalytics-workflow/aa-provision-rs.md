---
description: 設定CX Enterprise對應的報表套裝，以用於Advertising Analytics。
...
若要在Analytics中檢視任何Advertising Analytics搜尋資料，您必須為Advertising Analytics報表設定每個CX Enterprise對應的報表套裝。

1. 導覽至「**[!UICONTROL 管理員]** > **[!UICONTROL 報表套裝]**」。

1. 選取已對應至您CX Enterprise組織的報表套裝。
