...
管理員也可以[將存取權](/help/integrate/c-advertising-analytics/overview.md#section_FCC58EB635954A32990D4E67B52B4369)授予非管理員，以設定Advertising帳戶。
...
1. 免責宣告會顯示警告清單。 確認您已閱讀並瞭解本合約。 選取核取方塊，然後選取&#x200B;**[!UICONTROL 確定]**。
   ...
   您現在會進入Advertising帳戶[管理UI](/help/integrate/c-advertising-analytics/c-adanalytics-workflow/aa-manage-ad-accounts.md)，您新建立的帳戶應列於此處。
