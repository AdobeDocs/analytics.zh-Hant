...
6. [**行銷管道處理規則**](/help/admin/tools/manage-rs/edit-settings/marketing-channels/mc-proc-rules.md)：您可以使用[處理規則](/help/admin/tools/manage-rs/edit-settings/general/processing-rules/pr-overview.md)來準備要用於行銷管道處理規則的資料。
