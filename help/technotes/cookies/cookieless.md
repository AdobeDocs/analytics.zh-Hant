...
您可以使用[資料插入 API](https://developer.adobe.com/analytics-collection-apis/methods/data-insertion/) 或[大量資料插入 API](https://developer.adobe.com/analytics-collection-apis/methods/bulk-data-insertion/)，提交資料至 Analytics 伺服器端。 建議在新的伺服器端實作中使用大量資料插入 API。 如需這兩個 API 的比較情況，請參閱「[我應該使用哪一個 Adobe Analytics 工具](/help/analyze/get-started/which-analytics-tool.md)」。
