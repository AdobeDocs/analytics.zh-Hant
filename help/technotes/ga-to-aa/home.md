...
在Adobe Analytics中，登入Adobe Experience Cloud後提取基本報表的主要方式是使用&#x200B;**Analysis Workspace**。 左側功能表可讓使用者拖放元件，以建立自己專屬的報表。它提供更大的自由度，以符合確切的報表需求。 有建立 Google Analytics 儀表板和自訂報表使用經驗的使用者可能會發現此版面很熟悉。
