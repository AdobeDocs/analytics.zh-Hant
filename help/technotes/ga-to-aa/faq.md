...
**如何將我的歷史資料從第三方平台移轉至Adobe Analytics?**
...
**因為經常在報表中看到分段下拉式清單，我已經習慣了。How can I recreate that in[!UICONTROL Analysis Workspace]?**

Dropdown filters are a flexible and robust feature in [!UICONTROL Analysis Workspace] that allows a segmentation dropdown. 在工作區專案中：
