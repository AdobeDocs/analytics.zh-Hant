...
從 2023 年 2 月 16 日開始，客戶提示將被納入 Analytics 裝置查詢流程。 AppMeasurement 和 Web SDK 目前都支援收集提示資料，但在 2 日中旬之前不會用於裝置查詢。 如下所述，作業系統版本已於 10 月凍結，但由於是逐步推出和許多使用者代理已提供凍結的作業系統版本 (詳閱[這裡](https://experienceleague.adobe.com/docs/analytics/components/dimensions/operating-systems.html?lang=zh-Hant))，我們估計這將影響不到 3% 的 Chrome 訪客。
