...
* **Launch：** Adobe 目前的實施解決方案 Adobe Experience Platform Launch 的簡稱。請參閱 Adobe Experience Platform Launch 使用手冊中的[概觀](https://docs.adobe.com/content/help/zh-Hant/launch/using/overview.html)。
