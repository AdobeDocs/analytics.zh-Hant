...
* [組織者資源](/help/analyze/mobile-app/curator.md): 旨在協助資料組織者為主管使用者在[!UICONTROL 控制面板]上設定計分卡。 組織者可以是組織管理員，或是負責設定計分卡的其他角色的使用者。

   * [建立計分卡](/help/analyze/mobile-app/create-scorecard.md)
   * [協助主管完成應用程式設定和使用該應用程式](/help/analyze/mobile-app/set-up-execs.md)
...
* [主管使用者快速入門指南](/help/analyze/mobile-app/executive.md)：本指南旨在協助主管使用者閱讀及理解[!UICONTROL 儀表板]上的計分卡。此應用程式可讓主管使用者在自己的行動裝置上，輕鬆快速地檢視廣泛演算的重要摘要資料。
