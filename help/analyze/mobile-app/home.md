...
**Adobe Analytics[!UICONTROL  控制面板]**&#x200B;可隨時隨地提供 Adobe Analytics 的洞察。 此應用程式可讓使用者透過行動裝置存取直覺式計分卡。 計分卡是關鍵量度和其他元件的集合，以圖磚式版面配置呈現，點選上面的項目即可取得詳細劃分資料和趨勢報表。 iOS 和 Android 作業系統均支援行動應用程式。
