...
1. 如果看到工具列中新增加一個 Adobe Analytics 圖示 ![，表示下載成功。](assets/an_icon.png)您現在可以從網頁[啟動 Activity Map](/help/analyze/activity-map/activitymap-getting-started/activitymap-getting-started-users/activitymap-launch.md) 了。
