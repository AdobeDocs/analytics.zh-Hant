---
description: 在[!DNL Activity Map]或舊版ClickMap中開始連結追蹤的步驟。
seo-description: 在[!DNL Activity Map]或舊版ClickMap中開始連結追蹤的步驟。
seo-title: 開始連結追蹤
solution: Analytics
title: 開始連結追蹤
topic: Activity Map
...
<table id="table_1745199B3105467CBA26F50B3B1CCE99"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>將 <a href="https://marketing.adobe.com/resources/help/en_US/sc/implement/trackInlineStats.html" format="https" scope="external">trackInlineStats</a> 變數設定為 true。語法如下: 
     <code>
