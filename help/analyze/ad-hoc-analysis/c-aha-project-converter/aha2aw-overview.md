---
description: Ad Hoc Analysis 專案轉換器概觀
...
臨機分析專案轉換器可順暢地將您的臨機分析專案轉換為[分析工作區](https://docs.adobe.com/content/help/zh-Hant/analytics/analyze/analysis-workspace/home.html)。 專案可一次轉換一個，或大量轉換。
