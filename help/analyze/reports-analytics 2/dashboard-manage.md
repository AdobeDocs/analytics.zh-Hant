...
按一下 **[!UICONTROL Analytics]** > **[!UICONTROL 元件]** > **[!UICONTROL 所有元件]** > **[!UICONTROL 儀表板]**.
...
1. 前往 **[!UICONTROL Analytics]** > **[!UICONTROL 元件]** > **[!UICONTROL 所有元件]** > **[!UICONTROL 儀表板]**.
...
1. 在[!UICONTROL 「管理」]欄的[!UICONTROL 「舊式控制面板」]下方，按一下&#x200B;**[!UICONTROL 「複製到新控制面板」]**。
   ...
   另請參閱 [編輯控制面板和小報表資料](/help/analyze/reports-analytics/dashboard.md).

## 共用控制面板

Analytics管理員可共用（或推播）控制面板給多位使用者。 將控制面板推送給使用者後，控制面板即可用於使用者的[!UICONTROL 共用控制面板]功能表中。
