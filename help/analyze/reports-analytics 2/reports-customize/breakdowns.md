...
如果報表劃分依據 *`Referrer Type`*，您可能會看到的資料點 *`Inside Your Site`*. 這個值代表位於「內部 URL 篩選器」清單上的反向連結頁面。請參閱「管理參考」中的[內部 URL 篩選器](/help/admin/admin/c-manage-report-suites/c-edit-report-suites/general/internal-url-filter-admin.md)。
