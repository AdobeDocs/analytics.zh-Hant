...
description: Analysis Workspace、Adobe Analytics儀表板、Activity Map、Report Builder、報告API和報告與分析的產品檔案與自助。
...
* **[!UICONTROL Adobe Analytics儀表板]：此行** 動應用程式可讓使用者透過關鍵量度存取直覺式記分卡，並執行更詳細的劃分和趨勢報表。
...
* [適用於Adobe Analytics的漸進式網頁應用程式](/help/analyze/pwa/pwa.md)
