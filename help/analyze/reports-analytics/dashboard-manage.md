...
uuid: 380fd148-2ed9-43bb-9d42-46e373e788e4
...
>[!IMPORTANT]
>
>使用「控制面板管理員」時的最佳實務是，任何單一使用者都不能使用超過300個控制面板。此外，請注意，管理員會載入下方所有共用控制面板，因此共用控制面板十分異常。

## 控制面板管理員 {#concept_E1301CF138EB477794B00F693B4FCA0F}

使用「控制面板管理員」可以複製、共用、封存和排程控制面板的傳送。

Click **[!UICONTROL Analytics]** &gt; **[!UICONTROL Components]** &gt; **[!UICONTROL Dashboards]**.

<p class="head"> <b>控制面板管理員說明</b> </p>
...
<table id="table_EEE9323474DB432EB40EE33E1A85EE50"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>SiteCatalyst 14 伺服器將不再回應 Dashboard Player 的資料請求。目前顯示在 Dashboard Player 中的任何控制面板都能透過「Report &amp; Analytics」的標準介面存取，或重新建立為即時控制面板。即時控制面板是專門為持續顯示而設計，包含全螢幕模式，可供顯示在電視或其他大型螢幕裝置上。 </p> <p>使用者需執行的動作: 您需要停止使用 Dashboard Player。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 共用 </td> 
   <td colname="col2"> <p>顯示控制面板是否為共用。 </p> <p>請參閱 <a href="../../analyze/reports-analytics/dashboard-manage.md#task_2776BDE3FBC64E66B78DB6D6A53AAF49" format="dita" scope="local"> 共用控制面板 </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 已排程 </td> 
   <td colname="col2"> <p>可讓您計劃控制面板的傳送。 </p> <p>請參閱 <a href="../../analyze/reports-analytics/dashboard-manage.md#task_639361A35E044B2DB9D50FCABEC776FF" format="dita" scope="local"> 計劃報告的傳送 </a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 檢視封存 </td> 
   <td colname="col2"> <p>可讓您檢視控制面板封存檔。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 推送至使用者 </td> 
   <td colname="col2"> <p>可讓您共用控制面板。 </p> <p>請參閱 <a href="../../analyze/reports-analytics/dashboard-manage.md#task_2776BDE3FBC64E66B78DB6D6A53AAF49" format="dita" scope="local"> 共用控制面板 </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 管理 </td> 
   <td colname="col2"> <p>可讓您編輯、複製及刪除控制面板。 </p> </td> 
  </tr> 
 </tbody> 
</table>

## 管理共用控制面板 {#task_06BA6636471B4252A8A4DA2E99B9DFCF}
...
## 遷移舊式控制面板 {#task_64E4A29DB99644FA82EB3372243F1417}
...
>[!NOTE]
>
>新增舊式內容至控制面板會根據最新控制面板功能建立控制面板。不過，舊式小報告可能會包含以舊版資料平台為基礎的資料。
...
## 共用控制面板 {#task_2776BDE3FBC64E66B78DB6D6A53AAF49}
...
## 計劃報告的傳送 {#task_639361A35E044B2DB9D50FCABEC776FF}
...
## 封存控制面板 {#task_3B6AB949F0EC4063A08F80F254992117}
