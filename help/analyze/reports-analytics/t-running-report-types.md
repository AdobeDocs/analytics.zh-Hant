...
大多數轉換報告和流量報告具有可用的趨勢檢視。Using the [!UICONTROL Calendar], you can show improvement for any time period breakdowns, including days of a month, weeks of a year, weeks of a quarter, months of a year, and so on. 趨勢報告顯示單個度量 (收入、訂購、檢視等等) 的趨勢，可多達五個項目 (例如產品、類別、網頁等等) 的趨勢。
...
The [!UICONTROL Fallout Report] shows the number of visitors who visited a pre-specified sequence of pages. 也會顯示每個步驟之間的轉換率和流失率。
