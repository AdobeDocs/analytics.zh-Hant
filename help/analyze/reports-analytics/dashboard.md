...
1. 在[!UICONTROL 新增報告]頁面上，命名報告，然後從&#x200B;**[!UICONTROL 「在控制面板中的位置」]**&#x200B;中選取控制面板。
1. (可選) 設定日期範圍。

   * **[!UICONTROL 滾動]**：根據時間範圍 (每月、每日等)，隨時間流逝而變更日期。例如，如果今天是 1 月 17 日，您可能會將日期設定為 1 月 15 - 16 日。接著選取&#x200B;**[!UICONTROL 滾動]**，則在 1 月 27 日時，小報告會顯示 1 月 25 - 26 日的資料。
...
* **報告層級**：按一下&#x200B;**[!UICONTROL 「面板配置」]**，然後按一下您想要套用區段的報告套裝的報告。然後會出現一個強制回應視窗，讓您新增或變更報告要使用的區段。
