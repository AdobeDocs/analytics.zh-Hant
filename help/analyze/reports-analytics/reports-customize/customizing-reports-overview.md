...
1. 執行支援百分比的報告，例如[!UICONTROL 頁面報告]。
...
報告的時段會決定可用的精細度選項。例如，如果您已選定一天或兩天時間範圍，則只能選擇&#x200B;**[!UICONTROL 每小時]。**&#x200B;如果您已選定一年以上，則只能選擇&#x200B;**[!UICONTROL 每年]精細度。**

**要指定報告精細度**

1. Generate a trended report, such as **[!UICONTROL Site Content]** &gt; **[!UICONTROL Pages.]**
1.  按一下&#x200B;**檢視依據**&#x200B;連結，然後按一下粒度。
...
1. 在指定日期範圍執行趨勢報告。
1.  按一下&#x200B;**一週中的某天**&#x200B;連結，然後按一下某一天。

## 「在 Workspace 嘗試」按鈕{#concept_DA41E22460B94BD9ADF63B1CEE2714A7}

按一下在報告頂端的「**[!UICONTROL 在 Workspace 嘗試]」按鈕會載入與 Analysis Workspace 相同的報告。**
...
如需自訂報告所有方式的詳細資訊，請參閱 [Analysis Workspace](https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/) 指南。
