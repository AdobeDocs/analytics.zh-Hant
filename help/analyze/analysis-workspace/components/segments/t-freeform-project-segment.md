...
| 即席段： |  |  |  |
|  — 即席工作區項目段 | [拖放至專案的區段空投區中](/help/analyze/analysis-workspace/components/segments/ad-hoc-segments.md) | [僅限專案](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/components/segments/quick-segments.html?#what-are-project-only-segments%3F)，但可以儲存並新增至您的區段清單中。 | 若為單一規則區段 |
...
* [即席段](/help/analyze/analysis-workspace/components/segments/ad-hoc-segments.md)
