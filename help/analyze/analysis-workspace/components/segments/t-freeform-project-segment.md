...
| 快速區段 | [快速區段產生器](/help/analyze/analysis-workspace/components/segments/quick-segments.md) | [僅項目](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/components/segments/quick-segments.html?#what-are-project-only-segments%3F)，但可以保存並添加到段清單。 | 新增/編輯一個或多個規則的靈活性 |
| 臨時區段： |  |  |  |
| - 臨時工作區專案區段 | [拖放至專案的區段托放區中](/help/analyze/analysis-workspace/components/segments/ad-hoc-segments.md) | [僅項目](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/components/segments/quick-segments.html?#what-are-project-only-segments%3F)，但可以保存並添加到段清單。 | 若為單一規則區段 |
