...
| 「共用 &gt; 共用專案」或「共用 &gt; 組織專案資料」 | 在[「組織與共用」](https://docs.adobe.com/content/help/zh-Hant/analytics/analyze/analysis-workspace/curate-share/curate.html#concept_4A9726927E7C44AFA260E2BB2721AFC6)中，您可以瞭解套用至專案的區段可如何供收件者使用於共用分析中。 |
