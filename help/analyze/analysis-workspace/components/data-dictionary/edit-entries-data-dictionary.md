...
1. 確定在下拉選單中選取正確的報告套裝。 依預設，會顯示您目前所在的報告套裝。
...
1. (可選) 選取 **篩選器** 圖示 ![資料字典篩選器圖示](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Filter_18_N.svg)，然後選擇以下任一篩選器選項以篩選元件清單：
   ...
   | **[!UICONTROL 由Adobe建立]** <!-- I don't see this option--> | 僅顯示由 Adobe 建立的元件。  例如Adobe Target。 並不會顯示由管理員或您組織中的其他使用者建立的元件。 |
...
1. 編輯有關元件的以下任何資訊：
   ...
   | **[!UICONTROL 元件類型]** | 列出元件的類型，無論是維度、量度、區段還是日期範圍。 |
