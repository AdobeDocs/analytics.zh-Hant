...
若要瞭解如何在面板上使用區段放置區域來劃分面板區段，請參閱[面板概觀](/help/analyze/analysis-workspace/c-panels/panels.md)中的[放置區域](/help/analyze/analysis-workspace/c-panels/panels.md#drop-zone)。
