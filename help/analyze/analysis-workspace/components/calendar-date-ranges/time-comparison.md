---
description: 分析工作區中的日期比較可讓您擷取包含日期範圍的任何欄，並建立通用日期比較，例如年、季、月等。
seo-description: 分析工作區中的日期比較可讓您擷取包含日期範圍的任何欄，並建立通用日期比較，例如年、季、月等。
seo-title: 日期比較
title: 日期比較
...
分析需要內容，而通常這個內容是由先前的時段提供。例如，「我們的表現比去年的這個時候好/壞多少?」是您的公司要了解的基本問題。「日期比較」會自動包含「差別」欄，其中顯示相較於特定時段的變化百分比。
