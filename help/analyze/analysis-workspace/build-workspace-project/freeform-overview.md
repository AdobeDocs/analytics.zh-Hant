...
| [!UICONTROL Type] | 指出此專案是Workspace專案、資料夾還是[行動計分卡](https://experienceleague.adobe.com/en/docs/analytics/analyze/mobapp/home)。 |
...
| [Share](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/curate-share/send-schedule-files) | 組織、共用及排程 PDF/CSV 專案給貴組織中的收件者。 |
