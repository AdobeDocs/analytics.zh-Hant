...
When you first go to **[!UICONTROL Analytics]** > **[!UICONTROL Workspace]**, the page lists all the projects you own or have been shared to you. 這也是Adobe Analytics的著陸頁面，除非您先前已設定自訂著陸頁面。
...
| 元素 | 說明 |
|---|---|
| [建立新專案](/help/analyze/analysis-workspace/home.md) | 按一下此連結，從頭開始或從為您建立的范 [本](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/build-workspace-project/starter-projects.html?lang=en#analysis-workspace) ，開始新專案。 |
...
| 說明 | 存取說明檔案、影片和Analytics [Experience League社群](https://experienceleaguecommunities.adobe.com/t5/adobe-analytics/ct-p/adobe-analytics-community)。 管理工作區提示和除錯程式的可見 [性](https://www.adobe.io/apis/experiencecloud/analytics/docs.html#!AdobeDocs/analytics-2.0-apis/master/reporting-tricks.md)。 尋找有關工作區和影響專案效能的因素的 [詳細資訊](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/workspace-faq/optimizing-performance.html)。 |
...
| 動作 | 說明 |
|---|---|
| 新增 | 從頭開始建立新專案或從範本 [開始](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/build-workspace-project/starter-projects.html)。 |
