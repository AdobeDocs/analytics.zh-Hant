...
| ![共用](/help/assets/icons/ShareAlt.svg) | **[!UICONTROL 共用]** | 共用專案。 請參閱「[共用專案](/help/analyze/analysis-workspace/curate-share/share-projects.md)」了解更多。 |
| ![編輯](/help/assets/icons/Edit.svg) | **[!UICONTROL 重新命名]** | 重新命名專案。 開啟&#x200B;**[!UICONTROL 重新命名：*專案名稱對話框&#x200B;*]**。 輸入新名稱並選取「**[!UICONTROL 儲存&#x200B;]**」。 |
...
| 報表套裝 | 說明 |
|---|---|
| ![報告套裝](assets/projects-filters-reportsuites.png){width="300"} | **[!UICONTROL 報表套裝]**&#x200B;區段可讓您篩選報表套裝。 <ul><li>您使用![搜尋](/help/assets/icons/Search.svg) *搜尋報表套裝*&#x200B;來搜尋您要用來篩選的報表套裝。</li><li>您可以選取多個報告套裝。 適用的報告套裝取決於在篩選器面板其他區段所做的選擇。</li><li>這些數字是表示：<ul><li>**⃣**：目前篩選產生的專案可用的報表套裝數目。</li><li>4︎：與特定報表套裝相關聯的專案數目。</li></ul></li></ul> |
