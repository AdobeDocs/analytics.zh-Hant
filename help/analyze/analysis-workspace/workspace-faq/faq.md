...
| 問題 | 回答 |
|--- |--- |
| 使用 Analysis Workspace 的先決條件為何？ | [透過 Adobe Experience Platform Launch 將資料傳送至 Adobe Analytics](/help/implement/launch/validate-publish-prod.md)：使用 Analysis Workspace 需要先有效實作工具。請確認您的組織確實將資料傳送至 Adobe，再開始使用工具。其他實作方式 (例如舊版手動實作) 也可有效運用。 |
