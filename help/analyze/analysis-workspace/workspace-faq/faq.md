...
+++使用Analysis Workspace的先決條件為何？
[透過 Adobe Analytics 擴充功能將資料傳送至 Adobe Analytics](/help/implement/launch/validate-publish-prod.md)：使用 Analysis Workspace 需要運作中實作。使用工具之前，請確定您的組織將資料傳送至Adobe。 其他實作方式 (例如舊版手動實作) 也可有效運用。
+++
...
+++我將量度拖曳到專案後，系統沒有顯示任何實際資料，只顯示零。 如何疑難排解此問題？
