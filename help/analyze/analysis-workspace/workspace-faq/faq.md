...
| 問題 | 回答 |
|--- |--- |
| 使用 Analysis Workspace 的先決條件為何？ | [使用 Adobe Experience Platform 中的標記將資料傳送至 Adobe Analytics](/help/implement/launch/validate-publish-prod.md)：使用 Analysis Workspace 需要有效的實作。 請確認貴組織有將資料傳送至 Adobe，再開始使用此工具。 其他實作方式 (例如舊版手動實作) 也可有效運用。 |
