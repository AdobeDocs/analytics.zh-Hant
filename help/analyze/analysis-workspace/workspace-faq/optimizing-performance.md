...
| [!UICONTROL **月邊界**] | 請求中包括的月份數。月邊界越多，請求就越複雜。 建議為6個或更少。 | 如果這裡的請求速度變慢，可能是因為專案中的月份邊界太大。 請嘗試減少月數。 |
