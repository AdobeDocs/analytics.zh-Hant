...
| 錯誤訊息 | 為何發生這項錯誤？ | 最佳化 |
| --- | --- | --- |
| [!UICONTROL 發生系統錯誤。請在「說明 > 提交支援票證」中提出客戶服務請求，並附上錯誤代碼。] | Adobe 遇到需要解決的問題。 | 將錯誤代碼提交給客戶服務。 |
| [!UICONTROL 發生意外錯誤；再次嘗試重新整理您的專案。如果問題持續存在，請將此錯誤ID提交給Adobe客戶服務以進一步診斷。] | Adobe 遇到需要解決的問題。 | 嘗試重新整理您的專案，如果問題仍然存在，請將錯誤碼提交給客戶服務。 |
