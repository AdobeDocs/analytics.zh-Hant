...
1. 在「[!UICONTROL 另存為範本]」對話框中註明以下資訊：
   ...
   | **[!UICONTROL 使用案例]** | 選擇任何適用於此範本的使用案例。 您可以選取多個使用案例：**[!UICONTROL 參與度]**、**[!UICONTROL 轉換]**、**[!UICONTROL 客群]**，以及&#x200B;**[!UICONTROL 贏取]**。 <p>您選擇的選項會決定範本的顯示位置，以及從組織範本頁面存取該範本要採用的篩選器。</p> |
