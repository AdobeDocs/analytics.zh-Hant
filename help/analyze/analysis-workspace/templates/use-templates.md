...
| [!UICONTROL **下一頁**] | 檢視訪客造訪特定頁面後最常前往的位置。 <p>**這可協助您**&#x200B;更瞭解使用者造訪特定頁面後的行為。</p><p>**根據您瞭解的情況，您可**&#x200B;執行許多操作，例如評估頁面設計或版面配置是否可最佳化，以將使用者導向到更理想的頁面，例如購買或留下評論的頁面。</p> <p>此範本使用頁面維度和事件量度。</p> |
| [!UICONTROL **上一頁**] | 檢視訪客造訪特定頁面前最常前往的位置。 <p>**這可協助您**&#x200B;更瞭解哪些頁面會將最多流量導向特定頁面。</p><p>**根據您瞭解的情況，您可能**&#x200B;會執行許多動作，例如評估未顯示為先前頁面的頁面是否需要目前頁面的更顯眼連結。</p><p>此範本使用頁面維度和事件量度。</p> |
...
| [!UICONTROL **收入**] | 檢視所有訂單中購買之所有產品的金額。 會顯示一段期間內的資料，並與先前的期間進行比較。<p>**這有助於您**&#x200B;了解收入隨時間增加或減少的情況。您可以將這個量度與任何維度結合，以了解哪些維度項目對收入有貢獻。</p><p>**根據了解到的內容，您可以**&#x200B;採取各種行動，例如根據先前的趨勢預測未來的收入。您還可以新增另一個維度，例如追蹤程式碼維度，以了解哪些行銷活動所產生的收入最多。</p><p>此範本使用[天維度](/help/components/dimensions/day.md)和[收入量度](/help/components/metrics/revenue.md)。</p> |
| [!UICONTROL **訂購**] | 檢視購買事件總數。會顯示一段期間內的資料，並與先前的期間進行比較。 <p>**這可以協助您**&#x200B;更清楚瞭解您的產品和服務在一段時間內是否越來越感興趣。 您可以應用區段來了解哪些客戶或地區的訂單最多，以及這些訂單隨時間所呈現的趨勢。</p><p>**根據了解到的內容，您可以**&#x200B;採取各種行動，例如透過比較行銷活動發起前和發起後的訂單量，評估最近發起之行銷活動的成效。或者您可以比較逐年的假期訂單量。</p><p>此範本使用[天維度](/help/components/dimensions/day.md)和[訂單量度](/help/components/metrics/orders.md)。</p> |
...
| [!UICONTROL **串流媒體使用**] | 檢視所有數位裝置上媒體音訊使用量的趨勢和排名在前的量度。<p>**這可以幫助您**&#x200B;更加了解訪客如何在您的網站上使用音訊內容。</p><p>**根據了解到的內容，您可以**&#x200B;採取各種動作，例如分析哪些內容最常被使用。<p>此範本使用[造訪量度](/help/components/metrics/visits.md)和[不重複訪客量度](/help/components/metrics/unique-visitors.md)。</p> |
| [!UICONTROL **媒體造訪間隔、頻率、忠誠度**] | 檢視所有數位裝置上媒體使用的趨勢和排名在前的量度。<p>**這可以幫助您**&#x200B;更加了解使用者造訪您網站的平均次數、返回網站的頻率，以及回訪之間的天數。</p><p>**根據了解到的內容，您可以**&#x200B;採取各種動作，例如分析哪些內容最能有效地吸引人們返回網站。<p>此範本使用[造訪量度](/help/components/metrics/visits.md)和[不重複訪客量度](/help/components/metrics/unique-visitors.md)。</p> |
...
| **[!UICONTROL 頁面分析]** > [!UICONTROL **重新載入**] | 檢視重新載入期間維度項目出現的次數。訪客重新整理瀏覽器是觸發重新載入的最常見方式。 <p>**這可協助您**&#x200B;識別特定頁面上何時可能發生問題，以提示訪客重新載入頁面。</p><p>**根據了解到的內容，您可以**&#x200B;採取各種動作，例如評估哪些頁面有需要解決的問題。</p><p>此範本使用[重新載入量度](https://experienceleague.adobe.com/en/docs/analytics/components/metrics/reloads)。</p> |
...
| [!UICONTROL **Adobe Experience Manager**] > [!UICONTROL **表單效能總覽**] > [!UICONTROL **AEM表單效能**] | 檢視您Adobe Experience Manager Forms的效能資料。  <p>**這可以幫助您**&#x200B;更加了解 Adobe Experience Manager 的價值實現。</p><p>**根據了解到的內容，您可以**&#x200B;採取各種動作，例如將 Experience Manager 設定最佳化。</p> |
...
| 範本名稱 | 為何使用此範本<!-- What do you do with it? What can it help you learn? and What are the potential actions? --> |
| --- | --- | 
| [!UICONTROL **產品轉換漏斗**] | 在顯示購物車、結帳和訂購的漏斗視覺效果中檢視產品轉換。 您也可以檢視轉換百分比、收入平均值、單位平均和訂單平均值。<p>**這可協助您**&#x200B;更瞭解人們在轉換過程中如何進行和離開。</p><p>**根據您瞭解的情況，您可以**&#x200B;執行許多操作，例如改善您的網站，以方便更順暢的結帳程式。</p> |
...
| **類別** | 檢視與網站上每個產品類別相關聯的造訪次數。 如果您的實施作業使用產品變數，且您想要檢視產品類別的相關量度，此功能就十分實用。 如果您的網站上沒有任何產品，填入此範本的維度可能會刻意留空。<p>**這可協助您**&#x200B;更瞭解最暢銷或檢視次數最多的產品。 </p><p>**根據您所學到的內容，您可能**&#x200B;會執行許多動作，例如測量特定產品的行銷活動有效性。</p><p>此範本使用類別維度和造訪量度。 |
...
| **購買轉換漏斗** | 在顯示工作階段、購物車和訂單的漏斗視覺效果中檢視購買轉換。 您也可以檢視轉換百分比、收入平均值、單位平均和訂單平均值。<p>**這可協助您**&#x200B;更瞭解人們在轉換過程中如何進行和離開。</p><p>**根據您瞭解的情況，您可以**&#x200B;執行許多操作，例如改善您的網站，以方便更順暢的結帳程式。</p> |
...
| [!UICONTROL **件數**] | 檢視所有訂單中購買的單位總數。會顯示一段期間內的資料，並與先前的時段進行比較。 <p>**這有助於您**&#x200B;更加了解單位銷售量隨時間增加或減少的情況。您可以套用區段來了解哪些客戶或地區購買的單位最多，以及這些單位銷售量隨時間呈現的趨勢分析。</p><p>**根據了解到的內容，您可以**&#x200B;採取各種動作，例如比較行銷活動發起前與發起後的單位銷售量，評估最近發起之行銷活動的成效。或者您可以比較逐年的假期期間單位銷售量。</p><p>此範本使用[天維度](/help/components/dimensions/day.md)和[單位量度](/help/components/metrics/units.md)。</p> |
| [!UICONTROL **Magento：行銷和商務**] | 檢視零售商對您商業活動的預先建立深入解析，以幫助您提高銷售量。這是針對Adobe Commerce的使用者，但任何線上零售商都可以運用。 <p>**這可協助您**&#x200B;更瞭解您的商務活動對銷售數字的貢獻。</p><p>**根據您學到的內容，您可能**&#x200B;會做許多事情，例如調整預算以符合獲得最高ROI的活動。</p> |
...
| **訪客設定檔** > **時區** | 檢視存取您網站之訪客所在的熱門時區。 <p>**這可以幫助您**&#x200B;更加了解訪客居住的時區。</p><p>**根據您瞭解的情況，您可能**&#x200B;會執行許多動作，例如調整網站維護，有時只影響最少的人員數量。</p> |
...
| **訪客設定檔** > **技術** > **技術概覽** | 檢視與使用者用來存取網站的技術相關的資訊，例如作業系統、瀏覽器和裝置。 <p>**這可協助您**&#x200B;更清楚瞭解存取您的網站時最常使用的技術。</p><p>**根據您所學到的內容，您可能**&#x200B;會執行許多動作，例如針對使用的技術最佳化您的網站。</p> |
...
| **訪客保留率** > **銷售週期** > **客戶忠誠度** | 檢視您網站上先前購買 0 次、先前購買 1 次、先前購買 2 次或先前購買 3 次以上的訪客數量。 <p>**這可協助您**&#x200B;更瞭解您的網站如何影響購買行為。</p><p>**根據了解到的內容，您可以**&#x200B;採取各種動作，例如將焦點放在返回購買的訪客，藉此鼓勵新訪客也採取類似的行為。</p><p>此範本使用客戶忠誠度維度。</p> |
...
| **行動裝置** > **行動應用程式量度** | 檢視一些最常見的行動應用程式量度。 <p>**這可協助您**&#x200B;更瞭解行動應用程式的基本效能。</p><p>**根據您瞭解的情況，您可能**&#x200B;會執行許多動作，例如評估應用程式的整體健康狀況和效能。</p><!-- This template uses the --> |
...
| **Bot** | 檢視有關您網站上機器人流量的頁面檢視和趨勢。 <p>**這可協助您**&#x200B;根據您設定的機器人規則，更好地瞭解從報表中篩選的機器人流量數量。</p><p>**根據您瞭解的情況，您可能**&#x200B;會執行許多動作，例如繼續監視機器人活動以識別新模式。</p><!-- This template uses the --> |
...
| [!UICONTROL **行銷管道**] > [!UICONTROL **首次接觸管道**] | 檢視訪客在其參與期間（預設為30天）遇到的第一個相符行銷管道。 <p>**這有助於您**&#x200B;更加了解哪些行銷管道將初始流量導向您的網站。</p><p>**根據了解到的內容，您可以**&#x200B;採取各種行動，例如針對最有成效的領域加強行銷工作。</p><p>此範本使用首次接觸管道維度。</p> |
...
| [!UICONTROL **行銷活動**] > [!UICONTROL **行銷活動轉換漏斗**] | 檢視行銷活動的點進和結帳次數。 <p>**這可協助您**&#x200B;更瞭解行銷活動如何促進轉換。</p><p>**根據您瞭解的情況，您可能**&#x200B;會執行許多動作，例如判斷哪些行銷活動產生最多的ROI。</p> |
...
| **Advertising Analytics：付費搜尋** | 並排檢視您所有的 Google 和 Bing 付費搜尋資料。 <p>**這可以幫助您**&#x200B;更加了解傳送到您網站的流量，以及客戶是否正在轉換。</p><p>**根據您所學到的內容，您可能**&#x200B;會做許多事情，例如預估廣告行銷活動的成本效益。</p> |
...
| **所有搜尋頁面排名** | 檢視訪客點擊了搜尋結果中的哪一個頁面來進入您的網站。例如，若您的網站出現在搜尋引擎搜尋結果的第二頁，此變數的維度項目則為「搜尋頁面 2」。<p>**這可協助您**&#x200B;更瞭解您的頁面在搜尋結果中的排名如何。</p><p>**根據您瞭解的情況，您可能**&#x200B;會執行許多動作，例如改善您的SEO策略，以確保您的內容顯示在搜尋結果的第一頁。 </p> |
| **反向連結網域** | 檢視人們點進哪些網域來到達您的網站。<p>**這有助於您**&#x200B;更加了解哪些協力廠商網站為您的網站帶來最多流量。（外部網站上必須有連結，且訪客必須點按該連結，才會顯示維度專案。）</p><p>**根據您瞭解的情況，您可能**&#x200B;會執行任意數量的操作，例如建立或調整內容，以更符合來自頂級反向連結網域之訪客的興趣。 </p><p>此範本使用反向連結網域維度。 </p> |
...
| **反向連結** | 檢視訪客點進哪一個 URL 來到達您的網站。（外部URL上必須有連結，且訪客必須點按該連結，才會顯示維度專案。）  <p>**這有助於您**&#x200B;更加了解哪些特定 URL 為您的網站帶來最多流量。</p><p>**根據您瞭解的情況，您可能**&#x200B;會執行許多操作，例如建立或調整內容，以更符合來自頂層URL之訪客的興趣。 </p><p>此範本使用反向連結網域維度 </p><p>此範本使用反向連結維度。 </p> |
