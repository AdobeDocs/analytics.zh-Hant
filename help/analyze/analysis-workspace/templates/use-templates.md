...
>abstract="**這有助於您**&#x200B;更加了解人們首次登入網站時會前往哪些部分、人們最常造訪網站的哪些區段，以及哪些頁面最有可能導致人們離開網站。<br/>**根據已知內容，您可以**&#x200B;採取各種動作，例如評估網站上哪些路徑會吸引人們前往最重要的頁面，以及哪些頁面比較可能導致人們離開網站。<br/>此範本使用頁面維度和頁面瀏覽數量度、造訪次數量度、不重複訪客量度、登入率量度、跳出率量度、退出率量度和內容速度量度。此範本亦使用流量視覺化影像呈現進入、退出和熱門區段。"
...
>abstract="**這有助於您**&#x200B;更加了解人們首次登入網站時會前往哪些部分、人們最常造訪網站的哪些區段，以及哪些頁面最有可能導致人們離開網站。<br/>**根據已知內容，您可以**&#x200B;採取各種動作，例如評估網站上哪些路徑會吸引人們前往最重要的頁面，以及哪些頁面比較可能導致人們離開網站。<br/>此範本使用頁面維度和頁面瀏覽數量度、造訪次數量度、不重複訪客量度、登入率量度、跳出率量度、退出率量度和內容速度量度。此範本亦使用流量視覺化影像呈現進入、退出和熱門區段；利用散佈圖視覺化影像呈現最常用頁面的頁面瀏覽數；利用條狀圖視覺化影像依分段時間呈現頁面瀏覽數；以及利用折線圖視覺化影像呈現平均網站逗留時間的趨勢檢視。"
...
| **[!UICONTROL 登入和退出]** > [!UICONTROL **退出頁面**] | 檢視人們在離開您的網站前最常存取的頁面。<p>**這有助於您**&#x200B;更加了解哪些頁面會導致人們離開網站。 </p><p>**根據已知內容，您可以**&#x200B;採取各種行動，例如更新常用的退出頁面，讓即將離開網站的人們享有最佳化的體驗，或加入鼓勵人們停留在您網站上的內容或連結。</p><p>此範本使用「工作階段」量度。此範本亦使用長條圖視覺效果和自由格式表格視覺效果。</p> |
...
| **行動裝置** > **行動應用程式使用情況** | 檢視應用程式的使用者數量、啟動次數和首次啟動次數，以及平均作業長度。<p>**這有助於您**&#x200B;更了解應用程式的使用量。 </p><p>**根據已知內容，您可以**&#x200B;採取各種行動，例如提升應用程式效能，使其能夠根據使用量進行擴展。</p><!-- This template uses the --> |
| **行動裝置** > **行動應用程式歷程** | 檢視行動應用程式的主要使用模式。 <p>**這有助於您**&#x200B;更了解人們如何使用您的應用程式。 </p><p>**根據已知內容，您可以**&#x200B;採取各種行動，例如改善人們從一個畫面切換到另一個畫面的方式，協助他們完成最常見的工作流程。 </p><!-- This template uses the --> |
...
| **行動裝置** > **行動應用程式效能** | 檢視應用程式的執行效能以及使用者在哪些地方遇到問題。 <p>**這有助於您**&#x200B;更了解應用程式的使用者是否遇到速度緩慢或效能下降的問題。 </p><p>**根據已知內容，您可以**&#x200B;採取各種行動，例如修復現有問題，或在問題發生之前提升應用程式效能。</p><!-- This template uses the --> |
...
>abstract="**這有助於您**&#x200B;更加了解是什麼因素促成與行銷管道相符的點擊。例如，當訪客進入您的網站，並找到相符的「付費搜尋」行銷管道時，您可以使用管道詳細資料來了解他們使用哪個搜尋引擎，或已搜尋哪個關鍵字。<br/>**根據已知內容，您可以**&#x200B;採取各種動作，例如針對成效最好的領域加強行銷工作。<br/>此範本使用首次接觸管道詳細資訊維度。"
...
| [!UICONTROL **行銷管道**] > [!UICONTROL **首次接觸管道詳細資料**] | 檢視訪客在參與期間 (預設為 30 天) 符合之第一個行銷管道的詳細資訊。<p>**這有助於您**&#x200B;更加了解是什麼因素促成與行銷管道相符的點擊。例如，當訪客進入您的網站，並找到相符的「付費搜尋」行銷管道時，您可以使用管道詳細資料來了解他們使用哪個搜尋引擎，或已搜尋哪個關鍵字。</p><p>**根據已知內容，您可以**&#x200B;採取各種動作，例如針對成效最好的領域加強行銷工作。</p><p>此範本使用「首次接觸管道詳細資料」維度。</p> |
| [!UICONTROL **行銷管道**] > [!UICONTROL **上次接觸管道**] | 檢視訪客在參與期間 (預設為 30 天) 符合的最近行銷管道。<p>**這有助於您**&#x200B;更了解哪些行銷管道將初始流量導向您的網站而造成轉換。</p><p>**根據已知內容，您可以**&#x200B;採取各種行動，例如針對成效最好的地方加強行銷工作。</p><p>此範本使用「上次接觸管道」維度。  </p> |
| [!UICONTROL **行銷管道**] > [!UICONTROL **上次接觸管道詳細資料**] | 檢視訪客在參與期間 (預設為 30 天) 符合的最近行銷管道詳細資訊。<p>**這有助於您**&#x200B;更加了解是什麼因素促成與行銷管道相符的點擊。例如，當訪客進入您的網站，並找到相符的「付費搜尋」行銷管道時，您可以使用管道詳細資料來了解他們使用哪個搜尋引擎，或已搜尋哪個關鍵字。</p><p>**根據已知內容，您可以**&#x200B;採取各種動作，例如針對成效最好的領域加強行銷工作。 </p><p>此範本使用「上次接觸管道詳細資料」維度。 </p> |
...
| **搜尋關鍵字 - 所有** | 檢視訪客使用哪些搜尋關鍵字來到達您的網站，無論是付費或自然搜尋。 <p>**您可以藉此**&#x200B;更加了解人們搜尋哪些關鍵字會帶來網站流量。 </p><p>**根據已知內容，您可以**&#x200B;採取各種行動，例如找出所使用的關鍵字和能夠帶來網站流量的關鍵字之間有哪些 SEO 差距，並彌補這些差距。</p><p>此範本使用「搜尋關鍵字」維度。 </p> |
...
| **搜尋引擎 - 所有** | 檢視訪客使用哪些搜尋引擎來到達您的網站，無論是付費或自然搜尋。 <p>**這有助於您**&#x200B;更加了解人們使用哪些搜尋引擎而帶來網站流量。 </p><p>**根據了解到的內容，您可以**&#x200B;採取各種行動，例如針對為網站帶來最多流量的搜尋引擎加強 SEO 工作。</p><p>此範本使用「搜尋引擎」維度。 </p> |
