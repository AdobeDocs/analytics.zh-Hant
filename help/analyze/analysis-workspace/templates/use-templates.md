...
>title="檢視應用程式上的使用者人數、啟動和首次啟動次數，以及平均工作階段長度。"
>abstract="**這可協助您**&#x200B;更清楚瞭解您的應用程式目前的使用量。 <br/>**根據您的瞭解，您可能**&#x200B;會執行許多動作，例如改善應用程式效能，使其可擴充至使用量。"
...
>title="檢視行動應用程式的顯著使用模式。"
>abstract="**這可協助您**&#x200B;更瞭解人們如何使用您的應用程式。 <br/>**根據您所學到的內容，您可能**&#x200B;會做許多事情，例如改善人們在不同熒幕之間的互動方式，以鎖定最常見的工作流程。"
...
>abstract="**這可協助您**&#x200B;更瞭解行動應用程式的基本效能。<br/>**根據您瞭解的情況，您可能**&#x200B;會執行任何工作，例如評估應用程式的整體健康狀況和效能。"
...
>title="檢視應用程式內訊息和推送訊息的效能資料。"
>abstract="**這可協助您**&#x200B;更瞭解使用者如何使用應用程式內傳訊功能，以及推播通知如何有效地將流量引導至您的應用程式。<br/>**根據您的瞭解，您可能**&#x200B;會執行許多動作，例如改善應用程式內訊息推播通知體驗。"
...
>title="檢視應用程式的執行狀況以及使用者遇到問題的位置。"
>abstract="**這可協助您**&#x200B;更清楚瞭解使用您應用程式的人是否遇到效能緩慢或效能降低的問題。 <br/>**根據您瞭解的情況，您可以**&#x200B;執行任何動作，例如在問題發生之前修正現有問題或改善應用程式效能。"
...
>title="檢視哪些使用者是您應用程式最忠實的使用者，以及他們在應用程式中的行為。"
>abstract="**這可協助您**&#x200B;更瞭解您最忠實的使用者如何使用您的應用程式。<br/>**根據您瞭解的情況，您可**&#x200B;執行許多動作，例如針對您最忠實的使用者所使用的功能，改善行銷工作。"
...
| **行動裝置** > **行動應用程式使用情形** | 檢視應用程式上的使用者人數、啟動和首次啟動次數，以及平均工作階段長度。<p>**這可協助您**&#x200B;更清楚瞭解您的應用程式目前的使用量。 </p><p>**根據您的瞭解，您可能**&#x200B;會執行許多動作，例如改善應用程式效能，使其可擴充至使用量。</p><!-- This template uses the --> |
| **行動裝置** > **行動應用程式歷程** | 檢視行動應用程式的顯著使用模式。 <p>**這可協助您**&#x200B;更瞭解人們如何使用您的應用程式。 </p><p>**根據您所學到的內容，您可能**&#x200B;會做許多事情，例如改善人們在不同熒幕之間的互動方式，以鎖定最常見的工作流程。 </p><!-- This template uses the --> |
| **行動裝置** > **行動應用程式量度** | 檢視一些最常見的行動應用程式量度。 <p>**這可協助您**&#x200B;更瞭解行動應用程式的基本效能。</p><p>**根據您瞭解的情況，您可能**&#x200B;會執行任何工作，例如評估應用程式的整體健康狀況和效能。</p><!-- This template uses the --> |
| **行動裝置** > **行動應用程式訊息** | 檢視應用程式內訊息和推送訊息的效能資料。<p>**這可協助您**&#x200B;更瞭解使用者如何使用應用程式內傳訊功能，以及推播通知如何有效地將流量引導至您的應用程式。</p><p>**根據您的瞭解，您可能**&#x200B;會執行許多動作，例如改善應用程式內訊息推播通知體驗。</p><!-- This template uses the --> |
| **行動裝置** > **行動應用程式效能** | 檢視應用程式的執行狀況以及使用者遇到問題的位置。 <p>**這可協助您**&#x200B;更清楚瞭解使用您應用程式的人是否遇到效能緩慢或效能降低的問題。 </p><p>**根據您瞭解的情況，您可以**&#x200B;執行任何動作，例如在問題發生之前修正現有問題或改善應用程式效能。</p><!-- This template uses the --> |
| **行動裝置** > **行動應用程式保留率** | 檢視哪些使用者是您應用程式最忠實的使用者，以及他們在應用程式中的行為。 <p>**這可協助您**&#x200B;更瞭解您最忠實的使用者如何使用您的應用程式。</p><p>**根據您瞭解的情況，您可**&#x200B;執行許多動作，例如針對您最忠實的使用者所使用的功能，改善行銷工作。</p><!-- This template uses the --> |
