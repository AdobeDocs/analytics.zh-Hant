...
若要共用專案的連結，請前往您要共用的專案，然後選取前往 [!UICONTROL **共用**] > [!UICONTROL **與Workspace使用者共用**] > [!UICONTROL **透過連結共用**]. 您共用連結的使用者需要登入。
...
您可以與無法存取Analysis Workspace的人共用指向Adobe Analytics專案的唯讀連結。 您共用連結的使用者不需要登入。

如需詳細資訊，請參閱文章中的「與任何人共用專案（不需要登入）」 [共用專案](/help/analyze/analysis-workspace/curate-share/share-projects.md).
