...
>title="同類群組表格"
>abstract="根據事件的完成狀態將使用者分組，然後分析其在一段時間內的持續參與度及流失情況。<br/><br/>**參數&#x200B;**<br/>**納入條件**：用於定義初始訪客同類群組的元件。<br/>**回訪條件**：這些元件用以判斷訪客是否已回訪。"
...
請參閱 ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Analysis Workspace 中的同類群組分析](https://experienceleague.adobe.com/zh-hant/docs/analytics-learn/tutorials/analysis-workspace/cohort-analysis/cohort-analysis-workspace){target="_blank"}的示範影片。
