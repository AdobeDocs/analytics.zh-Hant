...
1. （可選）調整 **[!UICONTROL 同類群組表格設定]** 按一下齒輪圖示即可。
...
如同Analysis Workspace中的其他視覺效果，您也可以以CSV或PDF檔案格式下載同類群組視覺效果。 如需詳細資訊，請參閱 [下載PDF或CSV檔案](/help/analyze/analysis-workspace/curate-share/download-send.md).
