...
1. 將元件拖曳至&#x200B;**[!UICONTROL 新增接觸點]**&#x200B;下拉式功能表。
   ...
   例如，您可以將單一頁面新增至流失報表，而非整個維度。 按一下頁面維度上的向右箭頭![V形右](/help/assets/icons/ChevronRight.svg)，挑選特定頁面，例如&#x200B;**[!UICONTROL home]**，將其新增至流失報表。
...
1. 繼續新增接觸點，直到完成您的序列。
   ...
   * 將接觸點與其他接觸點結合。 若要合併接觸點，請將一個接觸點拖曳到另一個接觸點上。 當您看到單字&#x200B;**[!UICONTROL 合併]**&#x200B;時，請拖放它。

     ![結合接觸點](assets/fallout-combine-touchpoints.png)

   * 在路徑內將個別接觸點限製為下一個事件（而非&#x200B;*最終*）。 在每個接觸點下方，有一個選擇器，其選項為&#x200B;**[!UICONTROL 最終路徑]**&#x200B;和&#x200B;**[!UICONTROL 下一個事件]**，如下所示：
   ...
   * 將滑鼠指標暫留在接觸點上，即可檢視流失和該層級的其他相關資訊。 資訊包括接觸點的名稱、人員計數和成功率。 您也可以比較其他接觸點的成功率。
     ...
     ![接觸點工具提示](assets/fallout-tooltip.png)
