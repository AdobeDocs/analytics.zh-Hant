...
1. 您可以立即：
   ...
   * 將&#x200B;**縮放**&#x200B;到這個地圖中，以放大某些區域，方法是按兩下地圖或使用卷軸。 對應會根據您放置游標的位置進行縮放。 透過縮放互動，所需的維度（國家/地區>州/省>城市）會根據縮放等級自動更新。
   ...
   * 按住&#x200B;**Ctrl**&#x200B;鍵並移動地圖，以2D或3D方式[!UICONTROL 旋轉]地圖。

   * 使用下述的&#x200B;**設定**，[將](/help/analyze/analysis-workspace/visualizations/map-visualization.md#section_5F89C620A6AA42BC8E0955478B3A427E)切換至不同的檢視，例如熱度圖。 請注意，泡泡檢視是預設設定。
...
|--- |--- |
| **[!UICONTROL 地圖類型]** | |
| **[!UICONTROL 泡泡] | 使用泡泡繪製事件。 泡泡圖是一種多變數圖表，介於散點圖和比例面積圖之間。 此檢視為預設。 |
