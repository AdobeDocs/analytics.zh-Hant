...
Analysis Workspace 可讓您快速建置分析以收集深入分析，然後與其他人共用這些深入分析。透過拖放瀏覽器介面，您可以建立分析、新增視覺化呈現以生動呈現資料、組織資料集，以及與組織中您選擇的任何人共用和排程[專案](/help/analyze/analysis-workspace/build-workspace-project/freeform-overview.md)。
...
Analysis Workspace 的主要功能可透過按鈕面板使用：
...
| **[!UICONTROL 專案]** | Mac 快速鍵  | Windows 快速鍵 | 說明 |
|---|---|---|---|
| **[!UICONTROL 建立專案]** | **[!UICONTROL *Shift+Cmd+P *]** | **[!UICONTROL *Shift+Ctrl+P *]** | 建立新專案。 |
| **[!UICONTROL 建立行動計分卡]** | | | [建立新的行動計分卡](/help/analyze/mobile-app/create-scorecard.md)。 |
| **[!UICONTROL 開啟...]** | **[!UICONTROL *Cmd+O *]** | **[!UICONTROL *Ctrl+O *]** | [開啟現有專案](/help/analyze/analysis-workspace/build-workspace-project/save-projects.md#open-another-project)。 |
| **[!UICONTROL 開啟先前版本...]** | **[!UICONTROL *Opt+Cmd+O *]** | **[!UICONTROL *Alt+Ctrl+O *]** | [開啟專案的早期版本](/help/analyze/analysis-workspace/build-workspace-project/save-projects.md#open-previous-version)。 |
| **[!UICONTROL 儲存]** | **[!UICONTROL *Cmd+S *]** | **[!UICONTROL *Ctrl+S *]** | [儲存您的專案](/help/analyze/analysis-workspace/build-workspace-project/save-projects.md#save-projects)。 |
| **[!UICONTROL 一併儲存註釋...]** | **[!UICONTROL *Opt+Cmd+S *]** | **[!UICONTROL *Alt+Ctrl+S *]** | [新增註解至您儲存的專案版本中](/help/analyze/analysis-workspace/build-workspace-project/save-projects.md#save-project-options)。 |
| **[!UICONTROL 另存新檔]** | **[!UICONTROL *Shift+Cmd+S *]** | **[!UICONTROL *Shift+Ctrl+S *]** | [使用不同的名稱和詳細資訊儲存專案](/help/analyze/analysis-workspace/build-workspace-project/save-projects.md#save-project-options)。 |
| **[!UICONTROL 重新整理專案]** | **[!UICONTROL *Opt+R *]** | **[!UICONTROL *Alt+R *]** | 重新整理專案 |
| **[!UICONTROL 下載 CSV]** | **[!UICONTROL *Shift+Cmd+V *]** | **[!UICONTROL *Shift+Ctrl+V *]** | 將專案下載為 CSV 檔案。 |
| **[!UICONTROL 下載 PDF]** | **[!UICONTROL *Shift+Cmd+B *]** | **[!UICONTROL *Shift+Ctrl+B *]** | 將專案下載為 PDF 文件。 |
| **[!UICONTROL 專案資訊和設定]** | | | 定義專案的設定，例如名稱、標記、調色盤等。 |
| **[!UICONTROL 使用者設定]** | | | [設定使用 Analysis Workspace 的偏好設定](/help/analyze/analysis-workspace/user-preferences.md)。 |


| **[!UICONTROL 編輯]** | Mac 快速鍵  | Windows 快速鍵 | 說明 |
|---|---|---|---|
| **[!UICONTROL 還原]** | **[!UICONTROL *Cmd+Z *]** | **[!UICONTROL *Ctrl+Z *]** | 還原之前的動作。 |
| **[!UICONTROL 取消復原]** | **[!UICONTROL *Cmd+Shift+Z *]** | **[!UICONTROL *Ctrl+Shift+Z *]** | 取消復原之前的動作。 |
| **[!UICONTROL 全部清除]** | **[!UICONTROL *Opt+W *]** | **[!UICONTROL *Alt+W *]** | 清除目前專案中的所有面板。 |

| **[!UICONTROL 插入]** | Mac 快速鍵  | Windows 快速鍵 | 說明 |
|---|---|---|---|
| **[!UICONTROL 空白面板]** | **[!UICONTROL *Opt+B *]** | **[!UICONTROL *Alt+B *]** | 插入一個[空白面板](/help/analyze/analysis-workspace/c-panels/blank-panel.md)。 |
| **[!UICONTROL 媒體同時檢視者]** | **[!UICONTROL *Opt+H *]** | **[!UICONTROL *Alt-H *]** | 插入「[媒體同時檢視者](/help/analyze/analysis-workspace/c-panels/media-concurrent-viewers.md)」面板。 |
| **[!UICONTROL 媒體播放時間]** | **[!UICONTROL *Opt+I *]** | **[!UICONTROL *Alt+I *]** | 插入「[媒體播放時間](/help/analyze/analysis-workspace/c-panels/media-playback-time-spent.md)」面板。 |
| **[!UICONTROL 媒體平均分鐘觀眾數]** | **[!UICONTROL *Opt+M *]** | **[!UICONTROL *Alt+M *]** | 插入「[媒體平均分鐘觀眾數](/help/analyze/analysis-workspace/c-panels/average-minute-audience-panel.md)」面板。 |
| **[!UICONTROL 歸因]** | **[!UICONTROL *Opt+E *]** | **[!UICONTROL *Alt+E *]** | 插入「[歸因](/help/analyze/analysis-workspace/c-panels/attribution.md)」面板。 |
| **[!UICONTROL 自由格式]** | **[!UICONTROL *Opt+A *]** | **[!UICONTROL *Alt+A *]** | 插入「[自由格式](/help/analyze/analysis-workspace/c-panels/freeform-panel.md)」面板。 |
| **[!UICONTROL 快速深入分析]** | **[!UICONTROL *Opt+J *]** | **[!UICONTROL *Alt+J *]** | 插入「[快速深入分析](/help/analyze/analysis-workspace/c-panels/quickinsight.md)」面板。 |
| **[!UICONTROL 自由格式表格]** | **[!UICONTROL *Opt+1 *]** | **[!UICONTROL *Alt+1 *]** | 插入[自由格式表格](/help/analyze/analysis-workspace/visualizations/freeform-table/freeform-table.md)視覺化呈現。 |
| **[!UICONTROL 折線圖]** | **[!UICONTROL *Opt+2 *]** | **[!UICONTROL *Alt+2 *]** | 插入[折線圖](/help/analyze/analysis-workspace/visualizations/line.md)視覺化呈現。 |
| **[!UICONTROL 條狀圖]** | **[!UICONTROL *Opt+3 *]** | **[!UICONTROL *Alt+3 *]** | 插入[條狀圖](/help/analyze/analysis-workspace/visualizations/bar.md)視覺效果。 |
| **[!UICONTROL 組合]** | **[!UICONTROL *Opt+4 *]** | **[!UICONTROL *Alt+4 *]** | 插入[組合](/help/analyze/analysis-workspace/visualizations/combo-charts.md)視覺呈現。 |


| **[!UICONTROL 元件]** | Mac 快速鍵  | Windows 快速鍵 | 說明 |
|---|---|---|---|
| **[!UICONTROL 建立區段…]** | **[!UICONTROL *Shift+Cmd+E *]** | **[!UICONTROL *Shift+Ctrl+ E *]** | 建立新的[區段](/help/components/segmentation/segmentation-workflow/seg-create.md)。 |
| **[!UICONTROL 建立量度...]** | **[!UICONTROL *Shift+Cmd+C *]** | **[!UICONTROL *Shift+Ctrl+C *]** | 建立新的[計算量度](/help/components/calculated-metrics/cm-overview.md)。 |
| **[!UICONTROL 建立日期範圍...]** | **[!UICONTROL *Shift+Cmd+D *]** | **[!UICONTROL *Shift+Ctrl+D *]** | 建立新的[日期範圍](/help/analyze/analysis-workspace/components/calendar-date-ranges/calendar.md)。 |
| **[!UICONTROL 建立註解…]** | **[!UICONTROL *Shift+Cmd+O *]** | **[!UICONTROL *Shift+Ctrl+O *]** | 建立新的[註解](/help/analyze/analysis-workspace/components/annotations/overview.md) |
| **[!UICONTROL 重新整理元件]** | **[!UICONTROL *Opt+Shift+R *]** | **[!UICONTROL *Alt+Shift+R *]** | 重新整理專案中的元件。 |

| **[!UICONTROL 共用]** | Mac 快速鍵  | Windows 快速鍵 | 說明 |
|---|---|---|---|
| **[!UICONTROL 與 Workspace 使用者共用]** | **[!UICONTROL *Cmd+H *]** | **[!UICONTROL *Ctrl+H *]** | [與其他 Workspace 使用者共用專案](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-with-customer-journey-analytics-users-and-groups-in-your-organization)。 |
| **[!UICONTROL 與任何人共用]** | **[!UICONTROL *Opt+L *]** | **[!UICONTROL *Alt+L *]** | [與任何人共用專案的唯讀版本](/help/analyze/analysis-workspace/curate-share/share-projects.md#share-a-link-to-a-project)。 |
| **[!UICONTROL 傳送檔案]** | **[!UICONTROL Opt+S]** | **[!UICONTROL *Alt+S *]** | [將專案以 CSV 或 PDF 檔案傳送給其他收件者](/help/analyze/analysis-workspace/curate-share/send-schedule-files.md)。 |
| **[!UICONTROL 排程檔案匯出]** | **[!UICONTROL *Shift+Opt+S *]** | **[!UICONTROL *Shift+Alt+S *]** | [依排程將專案以 CSV 或 PDF 檔案傳送給其他收件者](/help/analyze/analysis-workspace/curate-share/send-schedule-files.md)。 |
| **[!UICONTROL 組織專案資料]** | **[!UICONTROL *Shift+Cmd+G *]** | **[!UICONTROL *Shift+Ctrl+G *]** | [組織專案資料](/help/analyze/analysis-workspace/curate-share/curate.md)。 |
...
將視覺效果同步處理，可控制哪些資料表或資料來源對應至視覺效果。請參閱[管理資料來源](/help/analyze/analysis-workspace/visualizations/t-sync-visualization.md)，了解更多資訊。
...
完成專案建置並開始收集可操作分析時，其他人可能想要使用此專案。您可以與組織中的使用者和群組 (或甚至組織外部的人員) 共用該專案。如需有關共用專案的資訊，請參閱[共用專案](/help/analyze/analysis-workspace/curate-share/share-projects.md)。

## 其他資源 {#resources}

- Adobe 提供數百項 [Analytics 影片培訓教學課程](https://experienceleague.adobe.com/zh-hant/docs/analytics-learn/tutorials/overview)。
- 如需有關新功能的更新，請參閱 [Adobe Experience Cloud 發行說明](https://experienceleague.adobe.com/zh-hant/docs/release-notes/experience-cloud/current)。
