...
| 功能 | 說明 |
|--- |--- |
| 支援工作區中的多個報表套裝 | 您現在可以將多個報表套裝的資料匯入單一專案，以並排檢視。 [更多詳情...](https://docs.adobe.com/content/help/zh-Hant/analytics/analyze/analysis-workspace/build-workspace-project/multiple-report-suites.html) |
...
| 功能 | 說明 |
|--- |--- |
| 使用跨裝置分析的組織適用的新工作區範本 | 此範本顯示CDA如何有效地將造訪連結在一起，並教育您瞭解CDA專屬的維度和量度。 需使用 CDA 的報表套裝。如需詳細資訊，請參閱[設定跨裝置分析](https://docs.adobe.com/content/help/zh-Hant/analytics/components/cda/cda-setup.html)。 |
| 工作區中的新快速鍵 | <ul><li>摺疊/展開所有面板：`alt + m`</li><li>摺疊/展開作用中的面板：`alt + ctrl + m`</li><li>搜尋左側欄：`ctrl + /`</li><li>移至下一個面板：`alt + Right Key`</li><li>移至上一個面板：`alt + Left Key`</li></ul>[更多詳情...](https://docs.adobe.com/content/help/zh-Hant/analytics/analyze/analysis-workspace/build-workspace-project/fa-shortcut-keys.html) |
...
| 功能 | 說明 |
|--- |--- |
| [自由表格產生器](https://docs.adobe.com/content/help/zh-Hant/analytics/analyze/analysis-workspace/visualizations/freeform-table.html) | 啟用「表格產生器」後，許多維度、劃分、量度和區段都可直接拖放使用，方便建立可回答更複雜商業問題的表格。資料不會立即更新，Instead, updates occur after you click **[!UICONTROL Build]**, saving you time once you know what table you want to construct. 此外，這項功能也提供以下輔助功能：<ul><li>**預覽**：演算實際資料前，您可以先預覽表格格式。</li><li>**彈性的表格列與劃分設定**：您可以針對每個維度列設定列與劃分層級。以前，Workspace 的預設內容只有在資料回傳後才能變更。</li><li>**依位置劃分**：您可以設定維度列，一律&#x200B;_依位置劃分_&#x200B;而非&#x200B;_依特定項目_&#x200B;劃分 (預設)。</li><li>**手動靜態列排序**：您可以手動排序靜態列，讓表格列能依您的需求顯示。以前，靜態列只能依量度欄或字母順序排序。</li></ul> |
...
| 增強功能 | 說明 |
|--- |--- |
| 更新為自由表格總計 | 自由表格現在包含兩個總計， **[!UICONTROL Table total]** a和a **[!UICONTROL Grand total]**。 表格總計列計入套用的[報表篩選器](https://docs.adobe.com/content/help/zh-Hant/analytics/analyze/analysis-workspace/build-workspace-project/pagination-filtering-sorting.html)。以前只有區段會影響總計。[更](https://docs.adobe.com/content/help/zh-Hant/analytics/analyze/analysis-workspace/build-workspace-project/workspace-totals.html)<br/>多資訊此外， **[!UICONTROL Show Totals]** 還 **[!UICONTROL Show Grand Total]** 新增了選項至 **[!UICONTROL Column Settings]**。<br/>對自由格式總計的這項變更，會更新相依的視覺化(例如連結的視覺 **[!UICONTROL Summary Number]** 化)，以及匯出的CSV和PDF資料。 |
| 移除「未指定/無」的選項 | 可輕鬆移除「未指定 (無)」的功能已新增為報表篩選器的選項。 |
| 取代紫色粒度元件 | 紫色粒度時間元件 (分鐘、小時、日、周、月、季、年) 已遭取代。紫色時間元件的行為一向會與其橘色維度元件完全相同，因此這項變更可簡化體驗。如果您先前已使用其中一個紫色時間元件，則&#x200B;**不需要採取任何動作**。<br/>透過這項變更，紫色 **[!UICONTROL Time]** 區段也已重新命名為 **[!UICONTROL Date Ranges]**。 |
...
| 增強功能 | 說明 |
|--- |--- |
| 最佳化最佳實務的增強功能 | [最佳化效能](/help/analyze/analysis-workspace/new-features-in-analysis-workspace.md) |
...
| 功能 | 說明 |
|--- |--- |
| [同類群組分析](/help/analyze/analysis-workspace/visualizations/cohort-table/cohort-analysis.md) | 同類群組分析的重大改善可讓您：<ul><li>分別套用區段包含和回訪量度。 </li><li>顯示客戶流失而非保留率。</li><li>顯示延遲表（包含事件前後經過的時間）。</li><li>自訂同類群組維度（以根據eVar而非只限時間對訪客分組）。</li><li>執行滾動式同類群組計算：根據先前時段 (而非原始同類群組) 計算保留率/流失率。 </li><li>在包含與返回欄位中新增多個量度，以及套用區段。 （不支援計算量度）</li></ul> |
...
| 效能改進 | 加速劃分視覺化的改善——包含大量劃分的專案載入速度會更快。 |

## 2018 年 11 月

2018年11月1日發行的新功能和增強功能。

| 功能 | 說明 |
|--- |--- |
| [VRS 與專案組織 - 增強功能](/help/analyze/analysis-workspace/curate-share/curate-projects-vrs.md) | 這些變更實際上已於 2018 年 10 月推出。管理員與非管理員可在已組織的 Workspace 專案和虛擬報表套裝 (VRS) 中查看的元件有所變動。<br>過去，只要按一下「顯示所有元件」，任何人都能查看未組織的元件。更新的組織體驗能讓您對可查看的元件執行更細微的控制。</br> |

## 2018 年 10 月

2018年10月11日發行的新功能和增強功能。
...
<table id="table_3DDC812B2F66416F868004416D248BF3"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p><b>面板下拉式管理</b> </p> </td> 
   <td colname="col2"> <p>我們對9月MR推出的小組流失管理做了一些改變。 現在用滑鼠右鍵按下拉式清單時，可以進行下列操作： </p> 
    <ul id="ul_4BDEC66EEB2243628FE32B43E377E5BD"> 
     <li id="li_EF8277BE972540D3B2604D82BC7C0918">刪除下拉式清單（此選項一律存在）。 </li> 
     <li id="li_6A991208F2744274817DBE1E9D1B443F">刪除標籤（如果顯示標籤）。 </li> 
     <li id="li_5C1CFC465C2E41D2B35E8841EFDC82AA">新增標籤（如果未顯示標籤）。 </li> 
    </ul> </td> 
  </tr> 
  <tr> 
...
<table id="table_137719BFA03C44A78FDE872DF8B228A4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>面板放置區域現在具備下拉式功能。 下拉式清單可讓使用者以受控制的方式與專案中的資料互動。 範例：假設您有數個專案版本，以提供國家／地區專屬的報表。 您現在可以將這些專案收合為單一專案，並改為新增國家／地區下拉式清單。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><b>調色盤</b> </p> </td> 
   <td colname="col2"> <p>您現在可以從不同的調色板中選擇，或指定自己的調色板，來更改「工作區」中使用的顏色配置。 這會影響工作區中的許多項目，包括大部分的視覺化項目。 它不會 <b>影響「摘要變更</b> 」、自由表格中的條件式格式，以及「地圖」視覺化。 </p> <p>注意：Internet Explorer 11 並不支援調色盤。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_DD77C02344414DCD9AC0A6A22E648B72"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p><b>放置區域指南</b> </p> </td> 
   <td colname="col2"> <p>這些參考線能讓您更容易了解每個拖放操作的作用。例如，當您將滑鼠指標暫留在欄上時，我們會顯示「新增」、「取代」、「篩選依據」和「劃分」等項目。 </p> <p>我們也新增黃色／紅色參考線，當您執行不建議或禁止的動作時，會提醒您，例如將兩個量度重疊在彼此之上（導致無效資料）。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><b>新增空白麵板選項</b> </p> </td> 
   <td colname="col2"> <p>我們在開始面板下方新增了+符號，讓您更輕鬆地新增其他面板。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_336E121310204DC492EA004F40830B0F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>歸因 IQ 可讓您針對行銷績效執行更精細的智慧化分析作業。新的歸因模型可用於分析工作區中的量度（在任何表格或任何劃分中）和計算量度。 全新的歸因面板可提供更理想的視覺化效果和比較功能。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><b> 左側導軌的改進 </b> </p> </td> 
   <td colname="col2"> <p>對左側導軌進行改良，讓它更直覺且易於使用： </p> 
    <ul id="ul_087BEDF4338946DA857CD82CB69F98C2"> 
     <li id="li_C751AACAC60442DC93118F0819F8EEA7"> 將元件（量度、區段、日期）的建立(+)函式內嵌在標題中。 </li> 
     <li id="li_DE2EB184A02D4CE58C23F518DB85EFDD"> 將「+全部檢視」新增至每個區段清單的底部，以清楚顯示有超過5個選項。 </li> 
     <li id="li_5208F3C6026647B09F4A85131B175175">選取元件時，具有圖示的已呈現動作（例如標籤、我的最愛）。 </li> 
     <li id="li_11E601488A844515928231E09889BC54">對使用者介面進行美感改良。 </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><b>計算量度總計 </b> </p> </td> 
   <td colname="col2"> <p>現在，我們會盡可能顯示計算量度的總計，包括百分比 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><b>新日 <a href="/help/analyze/analysis-workspace/components/calendar-date-ranges/calendar.md"  > 期範圍預 </a>設集 </b> </p> </td> 
   <td colname="col2"> <p>將「最近13週整」新增至「分析工作區」的日期範圍預設集。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_57035A06D99447A6BE6ED825A648ED3F"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><b>新工作區功能模型 </b> </p> </td> 
...
<table id="table_EE4C690A178B4F80BDAF2BB4424D6020"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p><b>每日秘訣</b> </p> </td> 
   <td colname="col2"> <p>我們將在介面的右下角提供「每日秘訣」（以及短片）。 這些提示旨在讓您熟悉眾多酷炫的分析工作區功能。 您可以選擇關閉這些秘訣，需要時可隨時前往<span class="uicontrol">「說明</span> &gt; <span class="uicontrol">秘訣」</span>查看。 </p> <p><img  src="assets/tip_of_day.png" width="300px" id="image_44A2AA712E4242EC92A180380E66AD7D" /> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>左側邊欄現在會顯示區段範本和計算量度範本。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><b>可在拖曳元件時捲動</b> </p> </td> 
   <td colname="col2"> <p>您現在可以在將元件拖曳至新位置時上下捲動。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><b>異常的其他資 <a href="/help/analyze/analysis-workspace/virtual-analyst/c-anomaly-detection/view-anomalies.md"  > 訊 </a></b> </p> </td> 
   <td colname="col2"> <p>暫留在折線圖中的異常時，資訊現在會顯示異常的日期和原始值。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_B9E784CD14A1453EB360FCCDC612250F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>針對堆疊區域圖/堆疊長條圖/堆疊橫條圖的全新視覺效果設定可讓圖表以「100% 堆疊」的視覺效果方式呈現；因此，你可以測量相對比例。 </p> <p><img placement="break"  src="assets/stacked_100_percent.png" width="500px" id="image_ED9C94CE5EAF4500B1EF71BE8701B6D2" /> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_824BBE4A554B4DB092ADA9044383D0FA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>即使在某些情況下，列會超過總數的 100% (例如平均值)，欄中顯示的「總數的百分比」上限還是 100%。 </p> <p>我們現在顯示的百分比大於100%，以便更準確。 我們也將上界限上限移至1,000%，以確保欄的寬度增長過大。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>依預設，「工作區」行事歷現在會顯示目前的月份和上個月，而非目前的月份和下個月。 </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_7A2E678577F94BDABB1276C826E6554F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>已新增多個維度項目的進階篩選選項 (除了現有的「包含」與「不包含」選項以外)： </p> 
    <ul id="ul_869B3E943E304C0282D56AD96BB79E18"> 
     ...
     <li id="li_16C7938EDC8F422EA006FB63F2881EF1">包含此片語 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>您現在可以按一下滑鼠右鍵並複製視覺化或面板，然後將複製的元素貼到專案內的其他位置，或貼到其他專案中。 </p> <p>您可以使用此功能來建立「建置區塊」（預先定義的視覺化／面板），這些區塊可複製到其他專案中，以便更快速地開始使用您業務的特定資料。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>新增兩項全新的專案範本： </p> 
    <ul id="ul_2F5976C849474A2B8A6BCDA2559F2855"> 
     <li id="li_51B7830E062A4CFDBDF219C56249A733">「訊息」的全新行動專案範本，著重於應用程式內和推播訊息效能。 </li> 
     <li id="li_D2FB258EF3AF4EB19CEB258D08F4EBBE">「位置」的全新行動專案範本，包含展示位置資料的地圖。 </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>調整欄大小改進 </p> </td> 
   <td colname="col2"> <p>調整最左側欄的大小時，工作區現在會維持其餘欄的寬度百分比（而不只是調整右側的下一欄寬度）。 此變更可加速建立分析和共用的表格。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>如果您的公司有有限數量的貢獻分析Token，分析工作區UI現在會在您使用Token時顯示通知。 讓您知道目前剩餘的代號數目。&amp;nbsp; </p> <p>(管理員使用者：您可編輯群組權限，限制可使用代號的使用者。)此權限稱為「異常偵測與貢獻度分析」，其位於<span class="uicontrol">「Analytics</span> &gt; <span class="uicontrol">管理</span> &gt; <span class="uicontrol">使用者管理</span> &gt; <span class="uicontrol">編輯群組</span> &gt; <span class="uicontrol">編輯所有報表存取權</span> &gt; <span class="uicontrol">自訂報表套裝工具</span> &gt; <span class="uicontrol">工具和報表」</span>當中。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>具有多個細節字元的CSV檔案 </p> </td> 
   <td colname="col2"> 現在可以在MS Excel中開啟包含多位元組字元的電子郵件CSV檔案。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>變更event#、eVar#和prop# </p> </td> 
   <td colname="col2"> <p>Event#、eVar#和prop#（在2017年）已新增至左側欄的維度名稱中)，只會在您搜尋元件時 <b>出現</b> 。 </p> <p>（也適用於虛擬報表套裝產生器。） </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>變更為無／未指定 </p> </td> 
   <td colname="col2"> <p>變更「無／未指定」在分析工作區中的運作方式，使其與「報告與分析」、「區段產生器」和「分析工作區」中的維度值選單一致。 </p> <p>這表示在「分析工作區」中，大部分專案中的值會顯示為「未指定」，而非「無」。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_C502E81253634E6CBAE7F12C7B62F7B6"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>有時候，並非專案中包含的所有元件都會包含在報表套裝中。 現在載入專案或切換至報表套裝時，顯示的「不相容的報表套裝」訊息會列出不相容的元件。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_892279F2B4AF4DB38C64AA9AFC5657A7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>當資料來源中的維度是時間維度時，您現在可以輕鬆地在時間粒度之間切換。 您可以從視覺化設定的下拉式清單中切換粒度。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="/help/analyze/analysis-workspace/components/t-freeform-project-segment.md"  > 區段放置區的完整維度和事件 </a> </p> </td> 
   <td colname="col2"> <p>以前，您只能將維度項目、日期範圍或區段拖放至區段拖放區域。 您現在可以將完整維度或事件拖放至區段拖放區。 在這兩種情況下，分析工作區都會建立「存在」點擊區段。 </p> <p>例子：「點撃 eVar1 存在的位置」或「點撃 event1 存在的位置」。 </p> <p>注意：您不可將計算量度放入區段區。只有您可以建立區段的維度/量度才可放入區段區域。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>如果有視覺化連接至自由表格或同類群組表格，左上角的點（「資料來源設定」）現在會列出已連線的視覺化。 暫留功能會反白顯示連結的視覺化效果，按一下就會帶您前往。 </p> <p>此外，還有「顯示／隱藏資料表格」核取方塊，可讓您顯示或隱藏資料表格。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>在2017年10月之前，evar#和prop#會附加至維度名稱，您可以搜尋這些數字。 現在，事件也可使用相同的功能。 </p> <p>範例：「訂閱」現於左側邊欄顯示為「訂閱 (event1)」 </p> <p>請記住： </p> 
    <ul id="ul_5DF85C65F7004539949DDC4F23922296"> 
     <li id="li_A685834B4914460D87568583BB39C474">事件編號不會顯示在表格中（以保持標題簡短）。 </li> 
     <li id="li_D742D04470244633900335B7F5A79FD9">為符合一致性，prop和eVar也不再在表格中顯示其數字。 </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>異常偵測信賴區間不會自動縮放視覺效果中的 Y 軸，如此可能會使圖表更清晰。 </p> <p>您現在可以選擇允許信賴區間縮放圖表。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_645B43AC6F554353B887DD58F0AA86E8"> 
     ...
     <li id="li_9F1ED138DB0E453DA6BD4B4A512492CC">新的左側導軌樣式讓左側導軌上的「面板」、「視覺化」和「元件」更顯眼，也更實用。 </li> 
...
<table id="table_DC0DA93B8A3B481080FCB2BA8F985753"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>您現在可以一次變更多欄的設定。 只要選取多欄，然後按一下其中任一欄的設定圖示即可。 您所做的任何變更都會套用至所有選取儲存格的欄。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>重新命名目前的兩種「摘要變更選項」以釐清意義： </p> 
    <ul id="ul_7301D1C73E72424F911EE8DAAD9247A0"> 
     <li id="li_89D94632E0C94263A84887AF5B360E27">顯示變更&gt;顯示變更百分比 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>以前，縮寫的「摘要數字／變更」視覺化顯示0個小數位。 </p> <p>您現在可以選擇0-3個小數位，以增強您的報表。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_64E3A9960F314E2F9FFC738696EACDF7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b>內部連結</b> ，可讓您從文字方塊向下連結至專案內的特定面板和視覺化，例如建立專案目錄。 您可以共用專案連結的方式共用這些連結，將使用者導向至專案內的特定視覺效果或面板。已新增「取得面板連結」和「取得視覺效果連結」滑鼠右鍵選項。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>可讓您重新命名視覺效果圖例（流失、區域、堆疊區域、長條、堆疊長條、環圈、色階分佈圖、水準長條、堆疊水準長條、長條、散布和垂直）中的系列名稱，以協助您讓視覺效果更易於消費。 </p> <p>編輯圖例<b>不</b>適用於：「樹狀圖」、「項目」、「摘要變更或數字」、「文字」、「自由格式」、「色階分布圖」、「同類群組」或「流量」視覺效果。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><b><a href="/help/analyze/analysis-workspace/visualizations/t-sync-visualization.md"  >「管理資料來源」的更新</a></b> </p> </td> 
   <td colname="col2"> <p>我們已重新開發資料來源 (強化視覺效果) 的管理方式。將資料源鎖定到表時，不再有單獨的隱藏表。 </p> <p>相反，我們會將視覺效果系結至您所建立的表格。 這也將解決即時連結表格的錯誤，您會在下次專案載入時變更詳細程度，然後回復為舊的詳細程度。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>現在，我們會在貢獻分析中以藍點反白標示異常，並連結智慧提醒專案。 如此即可以更清楚的方式指明分析所得的異常項目。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>您現在可以在「排程專案管理員」中篩選過期的專案。 然後，您可以決定是否要重新啟動或刪除這些專案。 </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_8A979BC0BE0F4D008F68B019A2D83A08"> 
     <li id="li_C8093834980B43A094FA9E2A7906E135">不限數量的區段供比較 </li> 
     <li id="li_45D709C9B04F4E6A9BD94FD03E0C80FA">能夠命名並更輕鬆地管理觸點群組（新增、移除、移動等） </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 日曆的變更可使其與「Reports &amp; Analytics」日曆的內容一致： 
    <ul id="ul_BD706B07369F4339BF4925F22FEC1C7F"> 
     <li id="li_33A47BAAD3C04C8784D2FC00A6F6782E">第一次點按會啟動日期範圍選擇。 然後在任一方向反白標示範圍，直到第二次點按，如此會選取日期範圍的結尾。 如果Shift鍵在按一下第一個日期時按住（或使用滑鼠右鍵），則會附加至範圍。 </li> 
     <li id="li_C3BEC56ABCED482C82A41EA0550B3077">延長各個滾動日期片段的回顧期間（例如，允許天數最多可回溯至兩年） </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><b>改進維度項目搜尋</b> </p> </td> 
   <td colname="col2"> 
    <ul id="ul_E955585818FF4553A869003B94DDB697"> 
     <li id="li_A37D2DB6290842578FE752DD8E712B73">增強的速度 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_7B6B794EDF874A4D87770AB9BAB42F33"> 
     <li id="li_0B403D892320434FBAD9A7F7B808947C"> 新增核取方塊以表示百分比截斷，尤其是百分比型量度（也適用於非百分比型量度）。 </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><b>元件管理器增 </b>強功能 </p> </td> 
   <td colname="col2"> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>已新增下列快捷鍵： </p> 
    <ul id="ul_5AE965D910DA4883BC2067CDFDBBA75A"> 
     <li id="li_6DBD6DFB9CA54F89B9A0627F3B1D5928">alt + shift + 1 =移至「面板」窗格 </li> 
     <li id="li_1B7E7C1115A84DB8A1BC07EA1C3AB15F">alt + shift + 2 =移至「視覺化」窗格 </li> 
     <li id="li_1BDB09DDEEDC4E7DB0D1C08A4E02A613">alt + shift + 3 =移至元件窗格 </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_53EEFB870ED943F5BFD71FAB2DBCE49B"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>「還原／重做」選項的改進 </p> </td> 
   <td colname="col2"> <p>這些清單會顯示分析工作區中可 <a href="/help/analyze/analysis-workspace/build-workspace-project/undo-redo.md"  > 以還不能還原／重做的內容 </a>。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_227D3668E9FD4FF4A1906FC619DCAFBF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>允許依表格位置劃分。例如：「我一律要劃分自由表格的前 7 列。」現在，當您建立自由表格時，會出現核取方塊，可讓您啟用「依位置劃分」。 預設會停用此設定。 </p> <p>之前，劃分中的值清單設為「鎖定」。這會導致一種情況 - 舉例來說 - 您執行「<span class="wintitle">依頁面</span>劃分<span class="wintitle">日期</span>」，會得到選取日期範圍內的前 50 頁清單。 </p> <p>如果儲存該報表，並在一個月後執行，前 50 頁可能會有所變更。不過，分析工作區「信任」原始劃分的結果，並傳回相同的頁面，但目前月份為日期範圍。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_0AB06B81BFA34521A9BF1150E64663C3"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>您現在可以在工作區中傳送和下載PDF，而不需儲存專案。 PDF檔案的名稱與專案的目前名稱相符。 下載的PDF包含專案中未儲存的變更。 請注意，您無法排程未儲存的專案。 （您也可以傳送和下載未儲存的CSV檔案，但無法排程這些檔案。） </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p>CSV格式的流失視覺化 </p> </td> 
   <td colname="col2"> <p>新增支援CSV格式的流失視覺化。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="/help/analyze/analysis-workspace/components/t-freeform-project-segment.md"  > 區段中的日期範圍 </a> </p> </td> 
   <td colname="col2"> <p>您可以將日期範圍拖放至區段拖放區域（例如，面板區段拖放區域、流失視覺化區段拖放區域等）。 日期範圍會自動轉換為區段。日期範圍可以是自訂和非自訂，但不是粒度，例如小時／天/周／月/季／年。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>您現在可以新增時段至表格中的每一欄，讓您新增與日曆設定不同的時段。 此功能是您比較日期的另一種方式。 您也可以將每欄的日期與同一列的所有開始日期對齊。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_9B2B9CC7A3574A99A716BF1C9745E32B"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>新的「日期比較」功能可讓您擷取任何欄，並建立通用的日期比較，例如：年比、季比、月比等。 </p> <p>「日期比較」會自動包含「差異」欄，顯示百分比變更。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_56258080C60F480AA83E1D5DE7D2C782"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>新的流失功能將為分析工作區帶來行銷漏斗功能。 漏斗可讓您識別客戶在與您的網站或跨通道促銷活動互動時，客戶在何處放棄行銷促銷活動或從定義的轉換路徑轉向。 流失分析可讓您建立具有新視覺化功能的強穩漏斗，以及分析工作區為識別關鍵成功度量的轉換所提供的固有彈性。 流失分析可讓您 </p> <p> </p> 
    <ul id="ul_E7C8255BA5D84F74ABBC6CC0E148DFB0"> 
     <li id="li_B7AC104F2A9348DCB2BCAA2FC9D3F3E6">拖放和重新排列漏斗步驟（觸點） </li> 
     <li id="li_CC85524BC64546CD84794CC02C24CF21">分析多維度流失（混合併比對不同維度和量度的值） </li> 
     <li id="li_FA59CEE0211E4894B9109FF6A2FA3F80">確定客戶流失後立即前往的後續步驟 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>新的流量功能可讓您在分析工作區中透過全新、更新且有彈性的視覺化，檢視客戶在網站／應用程式中的流量／歷程，以瞭解客戶在其網站／應用程式中的流動與進展。 流程可讓您 </p> <p> </p> 
    <ul id="ul_F1D4A99743664CB3B17E9485CF5E72FC"> 
     <li id="li_0F7AF953EAB746DC95032FF9A533E560">將客戶的跨資產歷程視覺化呈現 </li> 
     <li id="li_697A47BE06CF4284ACA3DBE4CA4012BF">分析客戶歷程中從進入、退出或特定維度項目開始的後續步驟 </li> 
     <li id="li_D13AD928AC434D599D43836FB334B14D">指定所選路徑中的特定點，以動態方式建立使用者區段 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>所有 Adobe Analytics 通用的全新警報系統，智慧型警報，可讓您在 Analysis Workspace 中建立與管理警報，並有完整的警報預覽與規則貢獻。您可以： </p> <p> </p> 
    <ul id="ul_02BD64D3047942009880B8F1DA1F2A40"> 
     <li id="li_01504AABBC514DF38354683843222541">根據異常（90%、95%或99%臨界值）建立警報；%變更；上／下)。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>讓您知道趨勢資料的變更是否重大，以及其原因。 </p> <p>現在「異常偵測」和「貢獻分析」是 Analysis Workspace 的核心工作流程。 </p> <p>重要提示：「貢獻分析」僅適用於 Adobe Analytics Premium 客戶。 </p> <p>您可以： </p> <p> </p> 
    <ul id="ul_9CEE47788F3640838D8598F2E2C020D6"> 
     <li id="li_787236BB5EA545B8833B311C06C24337">自動偵測資料中具統計意義的資料異常。 </li> 
     <li id="li_2FB3D94DEEF14DD5ADA6AD69E15F243D">針對任何每日異常執行貢獻分析，並將其內嵌在分析工作區專案中。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 為了讓使用者更容易開始使用分析工作區，我們針對常見商業問題建立了一些預先建立的專案範本，例如 <p> </p> 
    <ul id="ul_603F5ACC16F74D53AEB9F762FAC91656"> 
     <li id="li_6B3F2E5D4B044EC19D45E5501E33DB91">使用者保留 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>直方圖可讓使用者查看任何成功事件的使用者分佈。 您可以自訂儲存貯體和儲存貯體大小，以容納任何分配，並識別高價值和低價值使用者。 </p> <p><img placement="break"  src="assets/histogram3.png" width="500px" id="image_E3277073B50140E0A3FD7C1601CF9661" /> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_2585F74DC7754C819017F280E16BF06F"> 
     <li id="li_412446013E7F42DBB1BF50F9E2C4D92F"> 
      <!--AN-124610: -->將「計算重複例項」新增到專案層級的設定中 (「<span class="uicontrol">專案</span> &gt; <span class="uicontrol">專案資訊和設定」</span>)。此設定會指定是否在報表中計算重複例項。 如果您對相同變數有多個循序值，則可將其計為變數的一個或多個例項。 </li> 
     <li id="li_480E1B307C62418CBC2F50ADE32B9EE9">在「日曆」的「取消」和「執行」旁新增名為「套用至所有面板」的按鈕。 已將「執行」變更為「套用」。 如果您按一下新按鈕，它不僅會變更目前面板的選取日期範圍，也會變更專案中所有其他面板的日期範圍。 </li> 
     <li id="li_4D10DFE307344D06AA60792FABE5B57E"> 
      <!--AN-124168: -->左側導軌中新增了以下動作的「動作」按鈕：標記、收藏、核准、<b>共用 (新功能！)</b>, <b>刪除（新！）</b>。 </li> 
     <li id="li_946EC05568D4447193E9307546DF6F9B">新增篩選至搜尋列，可讓您篩選標籤、我的最愛、已核准項目和元件。 </li> 
     <li id="li_4EA118ACCD3B4F88B0ECF72717F631FA">新增預覽圖示至可讓您預覽區段、量度、日期範圍的手動列（而非列出維度項目的動態列）。 </li> 
     ...
     <li id="li_17AAABCA7B3A477182FB70453CA2EEBB">調整時間維度的列數。 </li> 
     <li id="li_35A91D50CD514CD0B939C24AEEC64BF4">更新「區段產生器」和「計算量度產生器」中左側導覽邊欄的外觀和感覺，使其看起來像「分析工作區」。 </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
* [新群組權限](https://marketing.adobe.com/resources/help/zh_TW/reference/groups.html) ，可讓管理員允許或拒絕使用者存取 **[!UICONTROL Analytics]** > **[!UICONTROL Workspace]** 標籤。 自2016年6月16日起，所有使用者都擁有存取此標籤的權限。 若要拒絕存取，只要從「分析工作區存取」群組移除使用者。
...
* [全新的「專案選單」結構](/help/analyze/analysis-workspace/build-workspace-project/freeform-overview.md) ，可重新排列頂端選單，讓它更具可擴充性。 例如，建立新的世代 **面板現在需要建立空白麵板** ，然後拖曳世代表格視覺化。
...
* 擴充的 [手動列功能](/help/analyze/analysis-workspace/build-workspace-project/column-row-settings/manual-vs-dynamic-rows.md) 。
* [新增區段](/help/analyze/analysis-workspace/components/t-freeform-project-segment.md) (Add Segment)拖放區
* 小幅更新：

   * 可刪除面板中所有的視覺效果和專案中的所有面板。（以前，您必須至少保留一個視覺化或一個面板。）
...
<table id="table_2649645FDED84B71952F741ABB3FC20E"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>透過電子郵件傳送 Analysis Workspace 專案，或排程進行傳送。參閱<a href="/help/analyze/analysis-workspace/curate-share/t-schedule-report.md"  >傳送檔案 - 排程專案進行傳送</a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 下載 PDF </td> 
   <td colname="col2"> <p>從「動作」功能表，您可以下載PDF格式的「分析工作區」專案（類似於以CSV格式下載）。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* [區段、量度和日期的另存新檔](/help/analyze/analysis-workspace/new-features-in-analysis-workspace.md#section_04C8B10A0751453AAE5F1BC35938C6CE)
...
* [標籤標題上的專案名稱](/help/analyze/analysis-workspace/new-features-in-analysis-workspace.md#section_497C61A030984BCCA2CEA553312C3226)
...
In a project, click **[!UICONTROL Link to This Project]** from the Actions menu to email a saved project&#39;s URL to other users. 管理收件者可以編輯並儲存以此方式共用的專案。 否則，這些專案是唯讀的。
...
顯示所提供的印象，以及有多少不重複使用者看過這些印象。 每個資料點的大小提供檢視者接觸廣告的平均次數的視覺提示。 大小和資料會依您選取的維度、日期範圍和篩選器而有所不同。

>[!NOTE]與散點圖關聯的表格至少需有兩個欄。第一列定義X軸，第二列定義Y軸。 如果有第三欄可用，散點圖會使用它來判斷點的半徑。 換句話說，欄、 *11*、22 *、* 3 *，映射至******* Columns、Y、X和X點半徑。

**樹狀圖**

將階層式（樹狀結構）資料顯示為一組巢狀矩形。 樹的每個分支都有一個矩形，然後與代表子分支的較小矩形平鋪。

![](assets/treemap.png)

當顏色和尺寸以某種方式與樹狀結構相關聯時，您通常可以很容易地看到以其他方式難以察覺的圖樣，例如某種顏色是否特別相關。 樹狀圖的第二個優勢是，通過構造，它們可以有效地利用空間。

## 區段、量度和日期的另存新檔 {#section_04C8B10A0751453AAE5F1BC35938C6CE}
...
<table id="table_4285E6982FBD4B66AC95AAF6C5C7B347"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 根據資料值，套用下列顏色至儲存格： </p> 
    ...
    </ul> <p>取代表格中的維度會重設條件式格式限制。取代量度會重新計算該欄的限制 (其中量度位在 X 軸，維度位在 Y 軸)。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 自動產生 </td> 
   <td colname="col2"> <p>自動產生條件式格式的限制。 上限是此欄中的最大值。 下限是最低限值，中點是上限和下限的平均值。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 自訂 </td> 
   <td colname="col2"> <p>您可以手動指派條件式格式的「<span class="uicontrol">上限</span>」、「<span class="uicontrol">中點</span>」和「<span class="uicontrol">下限</span>」欄位。這可提供由您決定欄的值是好、中等或壞的彈性。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
儲存專案時，瀏覽器標籤上的標題會顯示為「`<Project Name>` - Analysis Workspace」。如果您在多個瀏覽器標籤中開啟多個專案，此增強功能會很有幫助。
