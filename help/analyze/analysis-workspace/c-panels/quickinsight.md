...
| [!UICONTROL Visualization] | 工作區 [提供許多視覺化](/help/analyze/analysis-workspace/visualizations/freeform-analysis-visualizations.md) ，以建立資料的視覺化表示法，例如長條圖、環圈圖、直方圖、折線圖、地圖、散點圖等。 |
...
* 首先，完成教學 **[!UICONTROL More tips]** 課程： 透過說明(?)存取它 的雙曲餘切值。 [!UICONTROL Quick Insights Panel]
