...
*本文記錄了&#x200B;**Adobe Analytics**中的快速深入分析面板。<br/>檢視此文章的&#x200B;**Customer Journey Analytics**版本的[快速深入分析面板](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/panels/quickinsight)。*
