...
*本文會在&#x200B;**Adobe Analytics**中記錄歸因面板。<br/>檢視此文章的&#x200B;**Customer Journey Analytics**版本的[歸因面板](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/panels/attribution)。*
