...
* 使用 **首次接觸****，以及自訂回**&#x200B;顧視窗（共7天），歸因只會查看最近兩次瀏覽。 在此報告視窗中，社交媒體連結是第一個，因此$50購買的評分為100%。
* 如果採用&#x200B;**「線性」**&#x200B;和&#x200B;**「造訪回顧期間」**，評分會由電子郵件和顯示廣告平分，兩個管道各有 $25 美元的評分。
* 如果採用&#x200B;**「線性」**&#x200B;和&#x200B;**「訪客回顧期間」**，評分會由搜尋付費、社交媒體、電子郵件和顯示廣告平分，每個管道在這次購買中各有 $12.50 的評分。
* 使用 **線性****和7天的自訂回顧視窗** ，信用分為社交、電子郵件和顯示。 這些管道中的每個都可獲得$12.50的點數。 付費搜尋因未發生在指定的回顧視窗內而被排除。
...
* 如果採用&#x200B;**「時間耗損」**&#x200B;和&#x200B;**「訪客回顧期間」**，評分會由搜尋付費、社交媒體、電子郵件和顯示廣告拆分。以預設的 7 天半衰期計算，結果如下：
   * 顯示廣告接觸點與轉換之間的間隔為 0 天。`2`<sup>`(-0/7)`</sup> `= 1`
   * 電子郵件接觸點與轉換之間的間隔為 0 天。`2`<sup>`(-0/7)`</sup> `= 1`
   * 社交媒體接觸點與轉換之間的間隔為 6 天。`2`<sup>`(-6/7)`</sup> `= 0.552`
   * 付費搜尋接觸點與轉換之間的間隔為 9 天。`2`<sup>`(-9/7)`</sup> `= 0.41`
   * 將這些值標準化會產生下列結果：
