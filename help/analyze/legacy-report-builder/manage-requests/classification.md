...
存取分類的方式與存取報表套裝的其他報表的方式相同，且維度會顯示為群組內的頂層報表。 如果報表具有分類，則會建立功能表子群組來收集報表及其在相同位置的所有分類。 報表會顯示為分類中清單的最後一個專案。

請參閱[分類](/help/components/classifications/classifications-overview.md)。
