---
description: 您可以篩選新增至「列標籤」格線的維度。 篩選器可縮小要求傳回的資料範圍，並可從「樞紐配置」或「自訂配置」套用。 當您從「樞紐配置」設定維度篩選時，可以另外指定儲存格的專案數。
title: 篩選維度概觀
...
您可以篩選新增至「列標籤」格線的維度。 篩選器可縮小要求傳回的資料範圍，並可從「樞紐配置」或「自訂配置」套用。 當您從「樞紐配置」設定維度篩選時，可以另外指定儲存格的專案數。
...
<table id="table_8AC3A26FF02143DBA949B30F2A46CF11"> 
 <thead> 
  <tr> 
   ...
   <th colname="col2" class="entry"> 範例篩選條件 </th> 
   <th colname="col3" class="entry"> 符合結果 </th> 
  </tr> 
 </thead>
 <tbody> 
  <tr> 
   <td colname="col1"> <p>包含所有字詞 </p> </td> 
   <td colname="col02"> <p>包含任何順序的每個空格分隔值。 </p> </td> 
   <td colname="col2"> <p>a b c </p> </td> 
   <td colname="col3"> <p>符合<span class="term"> a b c</span>和<span class="term"> b a c</span>，依此類推。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>包含任何字詞 </p> </td> 
   <td colname="col02"> <p>包含至少一個篩選器（以空格分隔）。 </p> </td> 
   <td colname="col2"> <p>A B C </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>"^Home*Page$" |運動 </p> </td> 
   <td colname="col3"> <p> 這會定義一個篩選器，其開頭為<span class="term">首頁</span>，然後尋找零個或多個字元，最後以<span class="term">頁面</span>結束。 </p> <p>此外，也會尋找任何含有 <span class="term">sports</span> 的頁面。 </p> <p>以下是一些比對的範例： </p> 
    <ul id="ul_72D76C5AFEAF405E8A0E4E3C604D10AE"> 
     <li id="li_4D490059B667450DA8A0103167C7B391">首頁 </li> 
     <li id="li_1351619156274092AEB2771D882AD357">首頁和（其他字元）頁面 </li> 
     <li id="li_940EAA99A8CF49308E8471065EB317B1">家庭運動 </li> 
     <li id="li_50A895F14A454BE9BF06EE0F07F99B3B">運動頁面 </li> 
     <li id="li_F3CE0D07941D4C2485D2DE0B73E00677">運動 </li> 
...
<table id="table_8BBB06C8860745DEA41B39673699DC0F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>除非未與另一個引號配對，否則不會逸出。 例如，<span class="term"> 17" Display</span>不是片語。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> * </td> 
