...
**登入：**&#x200B;顯示[!UICONTROL 登入]表單，以便您可以使用您的憑證登入，或以其他使用者的身分登入。 同時在登入後部署您的公司名稱。請參閱[Report Builder登入](/help/analyze/legacy-report-builder/setup/login.md)。

**建立：**&#x200B;啟動[!UICONTROL 「請求精靈」]。如果您尚未登入，系統會提示您登入。請參閱[資料要求](/help/analyze/legacy-report-builder/data-requests/data-requests.md)。
...
**鎖定/解除鎖定：**&#x200B;您可以鎖定活頁簿，保護活頁簿中的所有請求，不讓他人新增及編輯。這樣可暫停所有報表請求，啟用活頁簿的離線編輯功能，進行更有效率的編輯。請參閱[鎖定/解除鎖定活頁簿](/help/analyze/legacy-report-builder/workbook-library/protect-wb.md)。
