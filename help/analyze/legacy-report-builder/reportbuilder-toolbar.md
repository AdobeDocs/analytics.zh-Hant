...
安裝Report Builder並啟動Excel後，請按一下&#x200B;**[!UICONTROL 增益集]**。

![Report Builder工具列圖示](assets/report_builder_toolbar.png)

**登入：**&#x200B;顯示[!UICONTROL 登入]表單，以便您可以使用您的憑證登入，或以其他使用者的身分登入。 也會在登入後顯示您的公司名稱。 請參閱[Report Builder登入](/help/analyze/legacy-report-builder/setup/login.md)。

**建立：**&#x200B;啟動[!UICONTROL 「請求精靈」]。 如果您未登入，系統會提示您登入。 請參閱[資料要求](/help/analyze/legacy-report-builder/data-requests/data-requests.md)。

**管理：**&#x200B;啟動[!UICONTROL 請求管理員]。 您可以檢視狀態、編輯、重新整理、刪除及管理內嵌於Excel活頁簿中的所有Report Builder資料請求。 您可以一次對個別請求或多個請求執行這些功能。 請參閱[管理要求](/help/analyze/legacy-report-builder/manage-requests/r-arb-manage-requests.md)。
...
**鎖定/解除鎖定：**&#x200B;您可以鎖定活頁簿，保護活頁簿中的所有請求，不讓他人新增及編輯。 這可暫停所有報表請求，以更有效率地編輯，進而啟用活頁簿的離線編輯。 請參閱[鎖定/解除鎖定活頁簿](/help/analyze/legacy-report-builder/workbook-library/protect-wb.md)。
