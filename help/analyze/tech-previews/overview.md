...
>[!NOTE] 目前 Labs 已經發行，僅供有限數量的客戶提早存取，日後將會廣泛發行。
...
Labs 已為所有管理員設為自動啟用。其他團隊成員則必須聯絡各自的產品管理員要求存取權。
...
1. 如果您尚無法存取 Workspace 和 Labs，請向您的管理員要求權限。
...
* 在原型中，您可以利用在 Workspace 中可存取的任何維度、量度、區段和視覺化來評估資料。
