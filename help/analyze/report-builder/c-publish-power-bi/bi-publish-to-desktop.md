...
1. 啟用&#x200B;**[!UICONTROL 「Power BI 服務即時連線」]**，然後按一下&#x200B;**[!UICONTROL 「確定」]**。![按一下「Power BI服務即時連線」，然後按一下「確定」。 ](assets/bi-preview-features.png)
...
如需詳細資訊，請參閱 [Microsoft部落格](https://powerbi.microsoft.com/en-us/blog/connecting-to-datasets-in-the-power-bi-service-from-desktop/).
