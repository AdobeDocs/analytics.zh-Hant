...
在Power BI中報告可以與分析報告API配合使用，因此API閾值限制應用。 有關詳細資訊，請參閱 [API調用的速率限制是多少？](https://developer.adobe.com/analytics-apis/docs/2.0/guides/faq/#what-is-the-rate-limit-for-api-calls)。
